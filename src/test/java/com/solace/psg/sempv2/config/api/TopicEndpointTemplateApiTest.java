...
/**
 * API tests for TopicEndpointTemplateApi
 */
@Ignore
public class TopicEndpointTemplateApiTest {

    private final TopicEndpointTemplateApi api = new TopicEndpointTemplateApi();
