...
/**
 * API tests for VirtualHostnameApi
 */
@Ignore
public class VirtualHostnameApiTest {

    private final VirtualHostnameApi api = new VirtualHostnameApi();
     ...
     */
    @Test
    public void createVirtualHostnameTest() throws ApiException {
     ...
     */
    @Test
    public void deleteVirtualHostnameTest() throws ApiException {
     ...
     */
    @Test
    public void replaceVirtualHostnameTest() throws ApiException {
        VirtualHostname body = null;
        String virtualHostname = null;
        String opaquePassword = null;
        List<String> select = null;
        VirtualHostnameResponse response = api.replaceVirtualHostname(body, virtualHostname, opaquePassword, select);
     ...
     */
    @Test
    public void updateVirtualHostnameTest() throws ApiException {
        VirtualHostname body = null;
        String virtualHostname = null;
        String opaquePassword = null;
        List<String> select = null;
        VirtualHostnameResponse response = api.updateVirtualHostname(body, virtualHostname, opaquePassword, select);
