...
public class MsgVpnReplayLogMsg {
  ...
  **/
   ...
   * @return priority
  **/
  @Schema(description = "The priority level of the message.")
  ...
  **/
  @Schema(description = "The name of the Replay Log.")
  ...
  **/
  @Schema(description = "The sequence number assigned to the message. Applicable only to messages received on sequenced topics.")
   ...
   * @return spooledTime
  **/
  @Schema(description = "The timestamp of when the message was spooled in the Replay Log. This value represents the number of seconds since 1970-01-01 00:00:00 UTC (Unix time).")
