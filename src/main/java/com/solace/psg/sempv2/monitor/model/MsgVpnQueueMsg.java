...
public class MsgVpnQueueMsg {
  ...
  **/
   ...
   * @return spooledTime
  **/
  @ApiModelProperty(value = "The timestamp of when the Message was spooled in the Queue. This value represents the number of seconds since 1970-01-01 00:00:00 UTC (Unix time).")
