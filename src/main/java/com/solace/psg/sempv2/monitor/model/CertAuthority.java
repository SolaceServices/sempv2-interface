...
public class CertAuthority {
  ...
  **/
   ...
   * @return crlDayList
  **/
  @ApiModelProperty(value = "The scheduled CRL refresh day(s), specified as \"daily\" or a comma-separated list of days. Days must be specified as \"Sun\", \"Mon\", \"Tue\", \"Wed\", \"Thu\", \"Fri\", or \"Sat\", with no spaces, and in sorted order from Sunday to Saturday.")
  ...
  **/
  @ApiModelProperty(value = "The timestamp of the last successful CRL download. This value represents the number of seconds since 1970-01-01 00:00:00 UTC (Unix time).")
  ...
  **/
  @ApiModelProperty(value = "The reason for the last CRL failure.")
  ...
  **/
  @ApiModelProperty(value = "The timestamp of the last CRL failure. This value represents the number of seconds since 1970-01-01 00:00:00 UTC (Unix time).")
  ...
  **/
  @ApiModelProperty(value = "The scheduled time of the next CRL download. This value represents the number of seconds since 1970-01-01 00:00:00 UTC (Unix time).")
   ...
   * @return crlTimeList
  **/
  @ApiModelProperty(value = "The scheduled CRL refresh time(s), specified as \"hourly\" or a comma-separated list of 24-hour times in the form hh:mm, or h:mm. There must be no spaces, and times must be in sorted order from 0:00 to 23:59.")
   ...
   * @return crlUp
  **/
  @ApiModelProperty(value = "Indicates whether CRL revocation checking is operationally up.")
   ...
   * @return crlUrl
  **/
  @ApiModelProperty(value = "The URL for the CRL source. This is a required attribute for CRL to be operational and the URL must be complete with http:// included.")
  ...
  **/
  @ApiModelProperty(value = "The reason for the last OCSP failure.")
  ...
  **/
  @ApiModelProperty(value = "The timestamp of the last OCSP failure. This value represents the number of seconds since 1970-01-01 00:00:00 UTC (Unix time).")
  ...
  **/
  @ApiModelProperty(value = "The URL involved in the last OCSP failure.")
  ...
  **/
  @ApiModelProperty(value = "Indicates whether a non-responder certificate is allowed to sign an OCSP response. Typically used with an OCSP override URL in cases where a single certificate is used to sign client certificates and OCSP responses.")
  ...
  **/
  @ApiModelProperty(value = "The OCSP responder URL to use for overriding the one supplied in the client certificate. The URL must be complete with http:// included.")
   ...
   * @return ocspTimeout
  **/
  @ApiModelProperty(value = "The timeout in seconds to receive a response from the OCSP responder after sending a request or making the initial connection attempt.")
  ...
  **/
  @ApiModelProperty(value = "Indicates whether Certificate Authority revocation checking is enabled.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(certAuthorityName, crlDayList, crlLastDownloadTime, crlLastFailureReason, crlLastFailureTime, crlNextDownloadTime, crlTimeList, crlUp, crlUrl, ocspLastFailureReason, ocspLastFailureTime, ocspLastFailureUrl, ocspNonResponderCertEnabled, ocspOverrideUrl, ocspTimeout, revocationCheckEnabled);
  }
