...
public class MsgVpnBridgeRemoteSubscription {
  ...
  **/
  @ApiModelProperty(value = "Indicates whether deliver-always is enabled for the Bridge remote subscription topic instead of a deliver-to-one remote priority. A given topic for the Bridge may be deliver-to-one or deliver-always but not both.")
  public Boolean isDeliverAlwaysEnabled() {
    return deliverAlwaysEnabled;
  }
  ...
  **/
  @ApiModelProperty(value = "The topic of the Bridge remote subscription.")
