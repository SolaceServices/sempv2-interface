...
public class DmrClusterLinkChannel {
   ...
   * @return bridgeName
  **/
  @Schema(description = "The name of the Bridge used by the Channel.")
   ...
   * @return clientName
  **/
  @Schema(description = "The name of the Client used by the Channel.")
  ...
  **/
   ...
   * @return establisher
  **/
  @Schema(description = "Indicates whether the local node established the Channel.")
  ...
  **/
  @Schema(description = "The failure reason for the Channel being down.")
  ...
  **/
   ...
   * @return queueName
  **/
  @Schema(description = "The name of the Queue used by the Channel.")
  ...
  **/
  @Schema(description = "The FQDN or IP address (and optional port) of the remote node.")
  ...
  **/
   ...
   * @return up
  **/
  @Schema(description = "Indicates whether the Channel is operationally up.")
  public Boolean isUp() {
    return up;
  }
   ...
   * @return uptime
  **/
  @Schema(description = "The amount of time in seconds since the Channel was up.")
