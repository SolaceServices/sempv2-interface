...
public class MsgVpnQueueTxFlow {
  ...
  **/
  @Schema(description = "The timestamp of when the bound Flow became active. This value represents the number of seconds since 1970-01-01 00:00:00 UTC (Unix time).")
  ...
  **/
  @Schema(description = "The state of updating the consumer with the Flow activity. The allowed values and their meaning are:  <pre> \"in-progress\" - The Flow is in the process of updating the client with its activity state. \"synchronized\" - The Flow has updated the client with its activity state. \"not-requested\" - The Flow has not been requested by the client to provide activity updates. </pre> ")
   ...
   * @return bindTime
  **/
  @Schema(description = "The timestamp of when the Flow bound to the Queue. This value represents the number of seconds since 1970-01-01 00:00:00 UTC (Unix time).")
  ...
  **/
  @Schema(description = "The identifier (ID) of the last message examined by the Flow selector.")
  ...
  **/
   ...
   * @return selector
  **/
  @Schema(description = "The value of the Flow selector.")
  ...
  **/
  @Schema(description = "The number of guaranteed messages examined by the Flow selector.")
  ...
  **/
  @Schema(description = "The number of guaranteed messages for which the Flow selector matched.")
  ...
  **/
  @Schema(description = "The number of guaranteed messages for which the Flow selector did not match.")
