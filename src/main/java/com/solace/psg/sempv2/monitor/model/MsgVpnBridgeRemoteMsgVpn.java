...
public class MsgVpnBridgeRemoteMsgVpn {
  ...
  **/
  @Schema(description = "The Client Username the Bridge uses to login to the remote Message VPN. This per remote Message VPN value overrides the value provided for the Bridge overall.")
  ...
  **/
  @Schema(description = "Indicates whether data compression is enabled for the remote Message VPN connection.")
   ...
   * @return connectOrder
  **/
  @Schema(description = "The preference given to incoming connections from remote Message VPN hosts, from 1 (highest priority) to 4 (lowest priority).")
  ...
  **/
  @Schema(description = "The number of outstanding guaranteed messages that can be transmitted over the remote Message VPN connection before an acknowledgement is received.")
   ...
   * @return enabled
  **/
  @Schema(description = "Indicates whether the remote Message VPN is enabled.")
  ...
  **/
  @Schema(description = "The reason for the last connection failure to the remote Message VPN.")
  ...
  **/
  @Schema(description = "The reason for the last queue bind failure in the remote Message VPN.")
  ...
  **/
   ...
   * @return queueBinding
  **/
  @Schema(description = "The queue binding of the Bridge in the remote Message VPN.")
  ...
  **/
  @Schema(description = "The amount of time in seconds since the queue was bound in the remote Message VPN.")
  ...
  **/
  @Schema(description = "The physical interface on the local Message VPN host for connecting to the remote Message VPN. By default, an interface is chosen automatically (recommended), but if specified, `remoteMsgVpnLocation` must not be a virtual router name.")
  ...
  **/
  @Schema(description = "The location of the remote Message VPN as either an FQDN with port, IP address with port, or virtual router name (starting with \"v:\").")
  ...
  **/
   ...
   * @return tlsEnabled
  **/
  @Schema(description = "Indicates whether encryption (TLS) is enabled for the remote Message VPN connection.")
  ...
  **/
  @Schema(description = "The Client Profile for the unidirectional Bridge of the remote Message VPN. The Client Profile must exist in the local Message VPN, and it is used only for the TCP parameters. Note that the default client profile has a TCP maximum window size of 2MB.")
   ...
   * @return up
  **/
  @Schema(description = "Indicates whether the connection to the remote Message VPN is up.")
  public Boolean isUp() {
    return up;
  }
