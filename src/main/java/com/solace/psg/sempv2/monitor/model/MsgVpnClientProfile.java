...
public class MsgVpnClientProfile {
  ...
  **/
  @Schema(description = "Indicates whether Bridge clients using the Client Profile are allowed to connect.")
  ...
  **/
  @Schema(description = "Indicates whether clients using the Client Profile are allowed to bind to endpoints with the cut-through forwarding delivery mode.")
  ...
  **/
  @Schema(description = "Indicates whether clients using the Client Profile are allowed to create durable and/or non-durable topic endponts or queues. The allowed values and their meaning are:  <pre> \"all\" - Client can create any type of endpoint. \"durable\" - Client can create only durable endpoints. \"non-durable\" - Client can create only non-durable endpoints. </pre>  Available since 2.14.")
  ...
  **/
  @Schema(description = "Indicates whether clients using the Client Profile are allowed to create topic endponts or queues.")
  ...
  **/
  @Schema(description = "Indicates whether clients using the Client Profile are allowed to receive guaranteed messages.")
  ...
  **/
  @Schema(description = "Indicates whether clients using the Client Profile are allowed to send guaranteed messages.")
  ...
  **/
  @Schema(description = "Indicates whether shared subscriptions are allowed. Changing this setting does not affect existing subscriptions.")
  ...
  **/
  @Schema(description = "Indicates whether clients using the Client Profile are allowed to establish transacted sessions.")
  ...
  **/
  @Schema(description = "The name of a queue to copy settings from when a new queue is created by a client using the Client Profile. The referenced queue must exist in the Message VPN. Deprecated since 2.14. This attribute has been replaced with `apiQueueManagementCopyFromOnCreateTemplateName`.")
  ...
  **/
  @Schema(description = "The name of a queue template to copy settings from when a new queue is created by a client using the Client Profile. If the referenced queue template does not exist, queue creation will fail when it tries to resolve this template. Available since 2.14.")
  ...
  **/
  @Schema(description = "The name of a topic endpoint to copy settings from when a new topic endpoint is created by a client using the Client Profile. The referenced topic endpoint must exist in the Message VPN. Deprecated since 2.14. This attribute has been replaced with `apiTopicEndpointManagementCopyFromOnCreateTemplateName`.")
  ...
  **/
  @Schema(description = "The name of a topic endpoint template to copy settings from when a new topic endpoint is created by a client using the Client Profile. If the referenced topic endpoint template does not exist, topic endpoint creation will fail when it tries to resolve this template. Available since 2.14.")
  ...
  **/
  @Schema(description = "Indicates whether clients using the Client Profile are allowed to use compression.")
   ...
   * @return elidingDelay
  **/
  @Schema(description = "The amount of time to delay the delivery of messages to clients using the Client Profile after the initial message has been delivered (the eliding delay interval), in milliseconds. A value of 0 means there is no delay in delivering messages to clients.")
  ...
  **/
  @Schema(description = "Indicates whether message eliding is enabled for clients using the Client Profile.")
  ...
  **/
  @Schema(description = "The maximum number of topics tracked for message eliding per client connection using the Client Profile.")
  ...
  **/
  @Schema(description = "The maximum number of client connections per Client Username using the Client Profile.")
  ...
  **/
  @Schema(description = "The effective maximum number of queues and topic endpoints per Client Username using the Client Profile.")
  ...
  **/
  @Schema(description = "The effective maximum number of receive flows per client using the Client Profile.")
  ...
  **/
  @Schema(description = "The effective maximum number of subscriptions per client using the Client Profile.")
  ...
  **/
  @Schema(description = "The effective maximum number of transacted sessions per client using the Client Profile.")
  ...
  **/
  @Schema(description = "The effective maximum number of transactions per client using the Client Profile.")
  ...
  **/
  @Schema(description = "The effective maximum number of transmit flows per client using the Client Profile.")
  ...
  **/
  @Schema(description = "The maximum number of transmit flows that can be created by one client using the Client Profile.")
  ...
  **/
  @Schema(description = "The maximum number of queues and topic endpoints that can be created by clients with the same Client Username using the Client Profile.")
  ...
  **/
  @Schema(description = "The maximum number of receive flows that can be created by one client using the Client Profile.")
  ...
  **/
  @Schema(description = "The maximum number of subscriptions per client using the Client Profile.")
  ...
  **/
  @Schema(description = "The maximum number of transacted sessions that can be created by one client using the Client Profile.")
  ...
  **/
  @Schema(description = "The maximum number of transactions that can be created by one client using the Client Profile.")
  ...
  **/
  @Schema(description = "The number of messages that are always allowed entry into the \"Control 1\" (C-1) priority queue, regardless of the `queueControl1MaxDepth` value.")
  ...
  **/
  @Schema(description = "The number of messages that are always allowed entry into the \"Direct 1\" (D-1) priority queue, regardless of the `queueDirect1MaxDepth` value.")
  ...
  **/
  @Schema(description = "The number of messages that are always allowed entry into the \"Direct 2\" (D-2) priority queue, regardless of the `queueDirect2MaxDepth` value.")
  ...
  **/
  @Schema(description = "The number of messages that are always allowed entry into the \"Direct 3\" (D-3) priority queue, regardless of the `queueDirect3MaxDepth` value.")
  ...
  **/
  @Schema(description = "The number of messages that are always allowed entry into the \"Guaranteed 1\" (G-3) priority queue, regardless of the `queueGuaranteed1MaxDepth` value.")
  ...
  **/
  @Schema(description = "Indicates whether to send a negative acknowledgement (NACK) to a client using the Client Profile when discarding a guaranteed message due to no matching subscription found.")
  ...
  **/
  @Schema(description = "Indicates whether clients using the Client Profile are allowed to connect to the Message VPN when its replication state is standby.")
  ...
  **/
  @Schema(description = "The maximum number of SMF client connections per Client Username using the Client Profile.")
  ...
  **/
  @Schema(description = "The timeout for inactive Web Transport client sessions using the Client Profile, in seconds.")
  ...
  **/
  @Schema(description = "The maximum number of Web Transport client connections per Client Username using the Client Profile.")
  ...
  **/
  @Schema(description = "The maximum Web Transport payload size before fragmentation occurs for clients using the Client Profile, in bytes. The size of the header is not included.")
  ...
  **/
  @Schema(description = "The TCP initial congestion window size for clients using the Client Profile, in multiples of the TCP Maximum Segment Size (MSS). Changing the value from its default of 2 results in non-compliance with RFC 2581. Contact Solace Support before changing this value.")
  ...
  **/
  @Schema(description = "The number of TCP keepalive retransmissions to a client using the Client Profile before declaring that it is not available.")
  ...
  **/
  @Schema(description = "The amount of time a client connection using the Client Profile must remain idle before TCP begins sending keepalive probes, in seconds.")
  ...
  **/
  @Schema(description = "The amount of time between TCP keepalive retransmissions to a client using the Client Profile when no acknowledgement is received, in seconds.")
  ...
  **/
  @Schema(description = "The TCP maximum segment size for clients using the Client Profile, in kilobytes. Changes are applied to all existing connections.")
  ...
  **/
  @Schema(description = "The TCP maximum window size for clients using the Client Profile, in kilobytes. Changes are applied to all existing connections.")
  ...
  **/
  @Schema(description = "Indicates whether clients using the Client Profile are allowed to downgrade an encrypted connection to plain text.")
