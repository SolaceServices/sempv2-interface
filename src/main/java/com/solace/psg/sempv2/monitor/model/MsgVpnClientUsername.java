...
public class MsgVpnClientUsername {
  ...
  **/
  @Schema(description = "The ACL Profile of the Client Username.")
  ...
  **/
  @Schema(description = "The Client Profile of the Client Username.")
  ...
  **/
  @Schema(description = "The name of the Client Username.")
   ...
   * @return dynamic
  **/
  @Schema(description = "Indicates whether the Client Username was dynamically created based on remote authorization data.")
   ...
   * @return enabled
  **/
  @Schema(description = "Indicates whether the Client Username is enabled.")
  ...
  **/
  @Schema(description = "Indicates whether the guaranteed endpoint permission override is enabled for the Client Username.")
  ...
  **/
  @Schema(description = "Indicates whether the subscription management capability is enabled for the Client Username.")
