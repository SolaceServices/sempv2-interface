...
public class MsgVpnClientUsername {
  ...
  **/
  @ApiModelProperty(value = "The ACL Profile of the Client Username.")
  ...
  **/
  @ApiModelProperty(value = "The Client Profile of the Client Username.")
  ...
  **/
  ...
  public MsgVpnClientUsername dynamic(Boolean dynamic) {
   ...
   * @return dynamic
  **/
  @ApiModelProperty(value = "Indicates whether the Client Username was dynamically created based on remote authorization data.")
   ...
   * @return enabled
  **/
  @ApiModelProperty(value = "Indicates whether the Client Username is enabled.")
  ...
  **/
  @ApiModelProperty(value = "Indicates whether the guaranteed endpoint permission override is enabled for the Client Username.")
  ...
  **/
  @ApiModelProperty(value = "Indicates whether the subscription management capability is enabled for the Client Username.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.aclProfileName, msgVpnClientUsername.aclProfileName) &&
        ...
        Objects.equals(this.dynamic, msgVpnClientUsername.dynamic) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(aclProfileName, clientProfileName, clientUsername, dynamic, enabled, guaranteedEndpointPermissionOverrideEnabled, msgVpnName, subscriptionManagerEnabled);
  }
