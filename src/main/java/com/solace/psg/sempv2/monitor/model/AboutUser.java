...
public class AboutUser {
  ...
  **/
  @Schema(description = "The global access level of the User. The allowed values and their meaning are:  <pre> \"admin\" - Full administrative access. \"none\" - No access. \"read-only\" - Read only access. \"read-write\" - Read and write access. </pre> ")
   ...
   * @return username
  **/
  @Schema(description = "The username of the User. Available since 2.17.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(globalAccessLevel, username);
  }
