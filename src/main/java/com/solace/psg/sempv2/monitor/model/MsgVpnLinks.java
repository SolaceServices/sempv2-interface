...
public class MsgVpnLinks {
  ...
  **/
   ...
   * @return clientsUri
  **/
  @ApiModelProperty(value = "The URI of this Message VPN's collection of Client objects. Available since 2.12.")
  ...
  **/
  @ApiModelProperty(value = "The URI of this Message VPN's collection of Config Sync Remote Node objects. Available since 2.12.")
  ...
  **/
  @ApiModelProperty(value = "The URI of this Message VPN's collection of Distributed Cache objects.")
  ...
  **/
  @ApiModelProperty(value = "The URI of this Message VPN's collection of DMR Bridge objects.")
  ...
  **/
  @ApiModelProperty(value = "The URI of this Message VPN's collection of JNDI Connection Factory objects.")
  ...
  **/
  @ApiModelProperty(value = "The URI of this Message VPN's collection of JNDI Queue objects.")
  ...
  **/
  @ApiModelProperty(value = "The URI of this Message VPN's collection of JNDI Topic objects.")
  ...
  **/
  @ApiModelProperty(value = "The URI of this Message VPN's collection of MQTT Retain Cache objects.")
  ...
  **/
  @ApiModelProperty(value = "The URI of this Message VPN's collection of MQTT Session objects.")
  ...
  **/
   ...
   * @return queuesUri
  **/
  @ApiModelProperty(value = "The URI of this Message VPN's collection of Queue objects. Available since 2.12.")
  ...
  **/
  @ApiModelProperty(value = "The URI of this Message VPN's collection of Replay Log objects.")
  ...
  **/
  @ApiModelProperty(value = "The URI of this Message VPN's collection of Replicated Topic objects. Available since 2.12.")
  ...
  **/
  @ApiModelProperty(value = "The URI of this Message VPN's collection of Topic Endpoint objects. Available since 2.12.")
  ...
  **/
  @ApiModelProperty(value = "The URI of this Message VPN's collection of Replicated Local Transaction or XA Transaction objects. Available since 2.12.")
