...
public class BrokerLinks {
   ...
   * @return aboutUri
  **/
  @Schema(description = "The URI of this Broker's About object.")
  ...
  **/
  @Schema(description = "The URI of this Broker's collection of Certificate Authority objects.")
  ...
  **/
  @Schema(description = "The URI of this Broker's collection of Cluster objects. Available since 2.11.")
   ...
   * @return msgVpnsUri
  **/
  @Schema(description = "The URI of this Broker's collection of Message VPN objects. Available since 2.11.")
   ...
   * @return uri
  **/
  @Schema(description = "The URI of this Broker object.")
  ...
  **/
  @Schema(description = "The URI of this Broker's collection of Virtual Hostname objects. Available since 2.17.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(aboutUri, certAuthoritiesUri, dmrClustersUri, msgVpnsUri, uri, virtualHostnamesUri);
  }
