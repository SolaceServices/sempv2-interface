...
public class DmrCluster {
  ...
  **/
  @Schema(description = "Indicates whether basic authentication is enabled for Cluster Links.")
  ...
  **/
  @Schema(description = "The type of basic authentication to use for Cluster Links. The allowed values and their meaning are:  <pre> \"internal\" - Use locally configured password. \"none\" - No authentication. </pre> ")
  ...
  **/
  @Schema(description = "Indicates whether client certificate authentication is enabled for Cluster Links.")
  ...
  **/
  @Schema(description = "Indicates whether this cluster only supports direct messaging. If true, guaranteed messages will not be transmitted through the cluster.")
  ...
  **/
   ...
   * @return enabled
  **/
  @Schema(description = "Indicates whether the Cluster is enabled.")
  ...
  **/
  @Schema(description = "The failure reason for the Cluster being down.")
  ...
  **/
  @Schema(description = "Indicates whether the common name provided by the remote broker is enforced against the list of trusted common names configured for the Link. If enabled, the certificate's common name must match one of the trusted common names for the Link to be accepted.")
  ...
  **/
  @Schema(description = "The maximum allowed depth of a certificate chain. The depth of a chain is defined as the number of signing CA certificates that are present in the chain back to a trusted self-signed root CA certificate.")
  ...
  **/
  @Schema(description = "Indicates whether validation of the \"Not Before\" and \"Not After\" validity dates in the certificate is enabled. When disabled, the certificate is accepted even if the certificate is not valid based on these dates.")
   ...
   * @return up
  **/
  @Schema(description = "Indicates whether the Cluster is operationally up.")
  public Boolean isUp() {
    return up;
  }
   ...
   * @return uptime
  **/
  @Schema(description = "The amount of time in seconds since the Cluster was up.")
