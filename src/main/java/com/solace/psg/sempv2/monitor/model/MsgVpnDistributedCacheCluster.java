...
public class MsgVpnDistributedCacheCluster {
  ...
  **/
  @Schema(description = "Indicates whether deliver-to-one override is enabled for the Cache Cluster.")
   ...
   * @return enabled
  **/
  @Schema(description = "Indicates whether the Cache Cluster is enabled.")
  ...
  **/
  @Schema(description = "Indicates whether global caching for the Cache Cluster is enabled, and the Cache Instances will fetch topics from remote Home Cache Clusters when requested, and subscribe to those topics to cache them locally.")
  ...
  **/
  @Schema(description = "The heartbeat interval, in seconds, used by the Cache Instances to monitor connectivity with the remote Home Cache Clusters.")
  ...
  **/
  @Schema(description = "The topic lifetime, in seconds. If no client requests are received for a given global topic over the duration of the topic lifetime, then the Cache Instance will remove the subscription and cached messages for that topic. A value of 0 disables aging.")
   ...
   * @return maxMemory
  **/
  @Schema(description = "The maximum memory usage, in megabytes (MB), for each Cache Instance in the Cache Cluster.")
  ...
  **/
  @Schema(description = "The maximum number of messages per topic for each Cache Instance in the Cache Cluster. When at the maximum, old messages are removed as new messages arrive.")
  ...
  **/
  @Schema(description = "The maximum queue depth for cache requests received by the Cache Cluster.")
  ...
  **/
  @Schema(description = "The maximum number of topics for each Cache Instance in the Cache Cluster.")
   ...
   * @return msgLifetime
  **/
  @Schema(description = "The message lifetime, in seconds. If a message remains cached for the duration of its lifetime, the Cache Instance will remove the message. A lifetime of 0 results in the message being retained indefinitely.")
  ...
  **/
   ...
   * @return msgsLost
  **/
  @Schema(description = "Indicates whether one or more messages were lost by any Cache Instance in the Cache Cluster.")
  ...
  **/
  @Schema(description = "Indicates whether advertising of new topics learned by the Cache Instances in this Cache Cluster is enabled.")
