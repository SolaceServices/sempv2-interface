...
public class MsgVpnTopicEndpointTemplate {
   ...
   * @return accessType
  **/
  @Schema(description = "The access type for delivering messages to consumer flows. The allowed values and their meaning are:  <pre> \"exclusive\" - Exclusive delivery of messages to the first bound consumer flow. \"non-exclusive\" - Non-exclusive delivery of messages to all bound consumer flows in a round-robin fashion. </pre> ")
  ...
  **/
   ...
   * @return deadMsgQueue
  **/
  @Schema(description = "The name of the Dead Message Queue (DMQ).")
  ...
  **/
   ...
   * @return maxBindCount
  **/
  @Schema(description = "The maximum number of consumer flows that can bind.")
  ...
  **/
  @Schema(description = "The maximum number of messages delivered but not acknowledged per flow.")
   ...
   * @return maxMsgSize
  **/
  @Schema(description = "The maximum message size allowed, in bytes (B).")
  ...
  **/
  @Schema(description = "The maximum message spool usage allowed, in megabytes (MB). A value of 0 only allows spooling of the last message received and disables quota checking.")
  ...
  **/
  @Schema(description = "The maximum number of message redelivery attempts that will occur prior to the message being discarded or moved to the DMQ. A value of 0 means to retry forever.")
  ...
  **/
  @Schema(description = "The number of messages that are permitted before low priority messages are rejected.")
  ...
  **/
  @Schema(description = "Indicates whether message priorities are respected. When enabled, messages are delivered in priority order, from 9 (highest) to 0 (lowest).")
  ...
  **/
  @Schema(description = "Indicates whether the time-to-live (TTL) for messages is respected. When enabled, expired messages are discarded or moved to the DMQ.")
