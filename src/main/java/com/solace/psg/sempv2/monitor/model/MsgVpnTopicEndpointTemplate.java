...
public class MsgVpnTopicEndpointTemplate {
  ...
  **/
  @ApiModelProperty(value = "The number of messages that are permitted before low priority messages are rejected.")
  ...
  **/
  @ApiModelProperty(value = "Indicates whether the time-to-live (TTL) for messages is respected. When enabled, expired messages are discarded or moved to the DMQ.")
  ...
  **/
  @ApiModelProperty(value = "The name of the Topic Endpoint Template.")
