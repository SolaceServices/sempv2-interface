...
public class MsgVpnAuthorizationGroup {
  ...
  **/
  @ApiModelProperty(value = "The ACL Profile of the LDAP Authorization Group.")
  ...
  **/
  @ApiModelProperty(value = "The Client Profile of the LDAP Authorization Group.")
   ...
   * @return enabled
  **/
  @ApiModelProperty(value = "Indicates whether the LDAP Authorization Group is enabled.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(aclProfileName, authorizationGroupName, clientProfileName, enabled, msgVpnName);
  }
