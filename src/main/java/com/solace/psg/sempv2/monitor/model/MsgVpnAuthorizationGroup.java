...
public class MsgVpnAuthorizationGroup {
  ...
  **/
  @Schema(description = "The ACL Profile of the LDAP Authorization Group.")
  ...
  **/
  @Schema(description = "The Client Profile of the LDAP Authorization Group.")
   ...
   * @return enabled
  **/
  @Schema(description = "Indicates whether the LDAP Authorization Group is enabled.")
