...
public class MsgVpnReplayLog {
  ...
  **/
  @Schema(description = "Indicates whether the transmission of messages from the Replay Log is enabled.")
  ...
  **/
  @Schema(description = "Indicates whether the reception of messages to the Replay Log is enabled.")
  ...
  **/
  @Schema(description = "The maximum spool usage allowed by the Replay Log, in megabytes (MB). If this limit is exceeded, old messages will be trimmed.")
  ...
  **/
  @Schema(description = "The spool usage of the Replay Log, in bytes (B).")
