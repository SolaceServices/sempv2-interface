...
public class MsgVpnReplayLog {
  ...
  **/
  @ApiModelProperty(value = "Indicates whether the transmission of messages from the Replay Log is enabled.")
  ...
  **/
  @ApiModelProperty(value = "Indicates whether the reception of messages to the Replay Log is enabled.")
  ...
  **/
  @ApiModelProperty(value = "The maximum spool usage allowed by the Replay Log, in megabytes (MB). If this limit is exceeded, old messages will be trimmed.")
  ...
  public MsgVpnReplayLog msgSpoolUsage(Long msgSpoolUsage) {
  ...
  **/
  @ApiModelProperty(value = "The spool usage of the Replay Log, in bytes (B).")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.egressEnabled, msgVpnReplayLog.egressEnabled) &&
        ...
        Objects.equals(this.msgSpoolUsage, msgVpnReplayLog.msgSpoolUsage) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(egressEnabled, ingressEnabled, maxSpoolUsage, msgSpoolUsage, msgVpnName, replayLogName);
  }
