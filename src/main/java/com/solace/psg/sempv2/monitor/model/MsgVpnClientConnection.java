...
public class MsgVpnClientConnection {
  ...
  **/
  @ApiModelProperty(value = "The IP address and TCP port on the Client side of the Client Connection.")
  ...
  **/
   ...
   * @return compression
  **/
  @ApiModelProperty(value = "Indicates whether compression is enabled for the Client Connection.")
   ...
   * @return encryption
  **/
  @ApiModelProperty(value = "Indicates whether encryption (TLS) is enabled for the Client Connection.")
  ...
  **/
  @ApiModelProperty(value = "The number of TCP fast retransmits due to duplicate acknowledgments (ACKs). See RFC 5681 for further details.")
  ...
  **/
  @ApiModelProperty(value = "The number of bytes currently in the receive queue for the Client Connection.")
  ...
  **/
  @ApiModelProperty(value = "The number of TCP segments received from the Client Connection out of order.")
  ...
  **/
  @ApiModelProperty(value = "The TCP smoothed round-trip time (SRTT) for the Client Connection, in nanoseconds. See RFC 2988 for further details.")
   ...
   * @return tcpState
  **/
  @ApiModelProperty(value = "The TCP state of the Client Connection. When fully operational, should be: established. See RFC 793 for further details. The allowed values and their meaning are:  <pre> \"closed\" - No connection state at all. \"listen\" - Waiting for a connection request from any remote TCP and port. \"syn-sent\" - Waiting for a matching connection request after having sent a connection request. \"syn-received\" - Waiting for a confirming connection request acknowledgment after having both received and sent a connection request. \"established\" - An open connection, data received can be delivered to the user. \"close-wait\" - Waiting for a connection termination request from the local user. \"fin-wait-1\" - Waiting for a connection termination request from the remote TCP, or an acknowledgment of the connection termination request previously sent. \"closing\" - Waiting for a connection termination request acknowledgment from the remote TCP. \"last-ack\" - Waiting for an acknowledgment of the connection termination request previously sent to the remote TCP. \"fin-wait-2\" - Waiting for a connection termination request from the remote TCP. \"time-wait\" - Waiting for enough time to pass to be sure the remote TCP received the acknowledgment of its connection termination request. </pre> ")
  ...
  **/
  @ApiModelProperty(value = "The number of TCP segments retransmitted due to timeout awaiting an acknowledgement (ACK). See RFC 793 for further details.")
  ...
  **/
  @ApiModelProperty(value = "The number of bytes currently in the transmit queue for the Client Connection.")
   ...
   * @return uptime
  **/
  @ApiModelProperty(value = "The amount of time in seconds since the Client Connection was established.")
