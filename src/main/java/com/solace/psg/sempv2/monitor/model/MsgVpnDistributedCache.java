...
public class MsgVpnDistributedCache {
  ...
  **/
   ...
   * @return enabled
  **/
  @Schema(description = "Indicates whether the Distributed Cache is enabled.")
   ...
   * @return heartbeat
  **/
  @Schema(description = "The heartbeat interval, in seconds, used by the Cache Instances to monitor connectivity with the message broker.")
  ...
  **/
   ...
   * @return msgsLost
  **/
  @Schema(description = "Indicates whether one or more messages were lost by any Cache Instance in the Distributed Cache.")
  ...
  **/
  @Schema(description = "The scheduled delete message day(s), specified as \"daily\" or a comma-separated list of days. Days must be specified as \"Sun\", \"Mon\", \"Tue\", \"Wed\", \"Thu\", \"Fri\", or \"Sat\", with no spaces, and in sorted order from Sunday to Saturday.")
  ...
  **/
  @Schema(description = "The scheduled delete message time(s), specified as \"hourly\" or a comma-separated list of 24-hour times in the form hh:mm, or h:mm. There must be no spaces, and times must be in sorted order from 0:00 to 23:59.")
