...
public class MsgVpnRestDeliveryPointQueueBinding {
  ...
  **/
  @Schema(description = "Indicates whether the authority for the request-target is replaced with that configured for the REST Consumer remote.")
  ...
  **/
  @Schema(description = "The reason for the last REST Delivery Point queue binding failure.")
  ...
  **/
  @Schema(description = "The timestamp of the last REST Delivery Point queue binding failure. This value represents the number of seconds since 1970-01-01 00:00:00 UTC (Unix time).")
  ...
  **/
  @Schema(description = "The request-target string being used when sending requests to a REST Consumer.")
  ...
  **/
  @Schema(description = "The name of a queue in the Message VPN.")
  ...
  **/
   ...
   * @return up
  **/
  @Schema(description = "Indicates whether the operational state of the REST Delivery Point queue binding is up.")
  public Boolean isUp() {
    return up;
  }
   ...
   * @return uptime
  **/
  @Schema(description = "The amount of time in seconds since the REST Delivery Point queue binding was up.")
