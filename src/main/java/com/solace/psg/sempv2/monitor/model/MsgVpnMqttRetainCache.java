...
public class MsgVpnMqttRetainCache {
  ...
  **/
  @Schema(description = "The name of the backup Cache Instance associated with this MQTT Retain Cache.")
  ...
  **/
  @Schema(description = "The reason why the backup cache associated with this MQTT Retain Cache is operationally down, if any.")
   ...
   * @return backupUp
  **/
  @Schema(description = "Indicates whether the backup cache associated with this MQTT Retain Cache is operationally up.")
   ...
   * @return backupUptime
  **/
  @Schema(description = "The number of seconds that the backup cache associated with this MQTT Retain Cache has been operationally up.")
   ...
   * @return cacheCluster
  **/
  @Schema(description = "The name of the Cache Cluster associated with this MQTT Retain Cache.")
   ...
   * @return cacheName
  **/
  @Schema(description = "The name of the MQTT Retain Cache.")
  ...
  **/
  @Schema(description = "The name of the Distributed Cache associated with this MQTT Retain Cache.")
   ...
   * @return enabled
  **/
  @Schema(description = "Indicates whether this MQTT Retain Cache is enabled. When the cache is disabled, neither retain messages nor retain requests will be delivered by the cache. However, live retain messages will continue to be delivered to currently connected MQTT clients.")
  ...
  **/
  @Schema(description = "The reason why this MQTT Retain Cache is operationally down, if any.")
   ...
   * @return msgLifetime
  **/
  @Schema(description = "The message lifetime, in seconds. If a message remains cached for the duration of its lifetime, the cache will remove the message. A lifetime of 0 results in the message being retained indefinitely.")
  ...
  **/
  @Schema(description = "The name of the primary Cache Instance associated with this MQTT Retain Cache.")
  ...
  **/
  @Schema(description = "The reason why the primary cache associated with this MQTT Retain Cache is operationally down, if any.")
   ...
   * @return primaryUp
  **/
  @Schema(description = "Indicates whether the primary cache associated with this MQTT Retain Cache is operationally up.")
  ...
  **/
  @Schema(description = "The number of seconds that the primary cache associated with this MQTT Retain Cache has been operationally up.")
   ...
   * @return up
  **/
  @Schema(description = "Indicates whether this MQTT Retain Cache is operationally up.")
  public Boolean isUp() {
    return up;
  }
   ...
   * @return uptime
  **/
  @Schema(description = "The number of seconds that the MQTT Retain Cache has been operationally up.")
