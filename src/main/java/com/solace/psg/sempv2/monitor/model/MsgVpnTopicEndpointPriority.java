...
public class MsgVpnTopicEndpointPriority {
  ...
  **/
   ...
   * @return priority
  **/
  @Schema(description = "The level of the Priority, from 9 (highest) to 0 (lowest).")
  ...
  **/
  @Schema(description = "The amount of guaranteed messages at this Priority spooled by the Topic Endpoint, in bytes (B).")
  ...
  **/
  @Schema(description = "The number of guaranteed messages at this Priority spooled by the Topic Endpoint.")
