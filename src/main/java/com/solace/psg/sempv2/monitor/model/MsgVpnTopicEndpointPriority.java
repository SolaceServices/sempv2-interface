...
public class MsgVpnTopicEndpointPriority {
  ...
  public MsgVpnTopicEndpointPriority msgVpnName(String msgVpnName) {
  ...
  **/
  ...
  public MsgVpnTopicEndpointPriority priority(Long priority) {
   ...
   * @return priority
  **/
  @ApiModelProperty(value = "The level of the Priority, from 9 (highest) to 0 (lowest).")
  ...
  public MsgVpnTopicEndpointPriority spooledByteCount(Long spooledByteCount) {
  ...
  **/
  @ApiModelProperty(value = "The amount of guaranteed messages at this Priority spooled by the Topic Endpoint, in bytes (B).")
  ...
  public MsgVpnTopicEndpointPriority spooledMsgCount(Long spooledMsgCount) {
  ...
  **/
  @ApiModelProperty(value = "The number of guaranteed messages at this Priority spooled by the Topic Endpoint.")
  ...
  public MsgVpnTopicEndpointPriority topicEndpointName(String topicEndpointName) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    MsgVpnTopicEndpointPriority msgVpnTopicEndpointPriority = (MsgVpnTopicEndpointPriority) o;
    return Objects.equals(this.msgVpnName, msgVpnTopicEndpointPriority.msgVpnName) &&
        Objects.equals(this.priority, msgVpnTopicEndpointPriority.priority) &&
        Objects.equals(this.spooledByteCount, msgVpnTopicEndpointPriority.spooledByteCount) &&
        Objects.equals(this.spooledMsgCount, msgVpnTopicEndpointPriority.spooledMsgCount) &&
        Objects.equals(this.topicEndpointName, msgVpnTopicEndpointPriority.topicEndpointName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(msgVpnName, priority, spooledByteCount, spooledMsgCount, topicEndpointName);
  }
  ...
  public String toString() {
    ...
    sb.append("class MsgVpnTopicEndpointPriority {\n");
