...
public class MsgVpnQueuePriority {
  ...
  **/
  @Schema(description = "The amount of guaranteed messages at this Priority spooled by the Queue, in bytes (B).")
  ...
  **/
  @Schema(description = "The number of guaranteed messages at this Priority spooled by the Queue.")
