...
public class MsgVpnDistributedCacheClusterInstanceClearEvent {
  /**
   * The name of the event. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4. The allowed values and their meaning are:  &lt;pre&gt; \&quot;lost-message\&quot; - Lost message event. &lt;/pre&gt; 
   */
   ...
   * @return eventName
  **/
  @Schema(description = "The name of the event. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4. The allowed values and their meaning are:  <pre> \"lost-message\" - Lost message event. </pre> ")
