...
public class MsgVpnDistributedCacheClusterInstanceClearEvent {
  /**
   * The name of the event. This attribute is absent from a GET and not updated when absent in a PUT. The allowed values and their meaning are:  &lt;pre&gt; \&quot;lost-message\&quot; - Lost message event. &lt;/pre&gt; 
   */
  ...
  public MsgVpnDistributedCacheClusterInstanceClearEvent eventName(EventNameEnum eventName) {
   ...
   * @return eventName
  **/
  @ApiModelProperty(value = "The name of the event. This attribute is absent from a GET and not updated when absent in a PUT. The allowed values and their meaning are:  <pre> \"lost-message\" - Lost message event. </pre> ")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    MsgVpnDistributedCacheClusterInstanceClearEvent msgVpnDistributedCacheClusterInstanceClearEvent = (MsgVpnDistributedCacheClusterInstanceClearEvent) o;
    return Objects.equals(this.eventName, msgVpnDistributedCacheClusterInstanceClearEvent.eventName);
  }
  ...
  public String toString() {
    ...
    sb.append("class MsgVpnDistributedCacheClusterInstanceClearEvent {\n");
