...
public class MsgVpnQueueLinks {
  ...
  **/
  @Schema(description = "The URI of this Queue's Cancel Replay action.")
  ...
  **/
  @Schema(description = "The URI of this Queue's Clear Stats action.")
   ...
   * @return msgsUri
  **/
  @Schema(description = "The URI of this Queue's collection of Queue Message objects.")
  ...
  **/
  @Schema(description = "The URI of this Queue's Start Replay action.")
   ...
   * @return uri
  **/
  @Schema(description = "The URI of this Queue object.")
