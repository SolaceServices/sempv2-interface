...
public class MsgVpnLinks {
  ...
  **/
  @ApiModelProperty(value = "The URI of this Message VPN's Clear Stats action.")
  ...
  **/
   ...
   * @return clientsUri
  **/
  @ApiModelProperty(value = "The URI of this Message VPN's collection of Client objects.")
  ...
  **/
  @ApiModelProperty(value = "The URI of this Message VPN's collection of Topic Endpoint objects.")
