...
public class SempRequest {
   ...
   * @return method
  **/
  @ApiModelProperty(required = true, value = "The HTTP method of the request which resulted in this response.")
   ...
   * @return uri
  **/
  @ApiModelProperty(required = true, value = "The URI of the request which resulted in this response.")
