...
public class MsgVpnDistributedCacheClusterInstanceRestoreCachedMsgs {
  ...
  public MsgVpnDistributedCacheClusterInstanceRestoreCachedMsgs filename(String filename) {
   ...
   /**
   * The filename for restoring the cached messages. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4.
   * @return filename
  **/
  @Schema(description = "The filename for restoring the cached messages. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4.")
