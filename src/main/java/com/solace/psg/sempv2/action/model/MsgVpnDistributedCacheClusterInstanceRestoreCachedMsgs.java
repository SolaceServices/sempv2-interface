...
public class MsgVpnDistributedCacheClusterInstanceRestoreCachedMsgs {
  @SerializedName("filename")
  private String filename = null;

  public MsgVpnDistributedCacheClusterInstanceRestoreCachedMsgs filename(String filename) {
    this.filename = filename;
    return this;
  }

   /**
   * The filename for restoring the cached messages. This attribute is absent from a GET and not updated when absent in a PUT.
   * @return filename
  **/
  @ApiModelProperty(value = "The filename for restoring the cached messages. This attribute is absent from a GET and not updated when absent in a PUT.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    MsgVpnDistributedCacheClusterInstanceRestoreCachedMsgs msgVpnDistributedCacheClusterInstanceRestoreCachedMsgs = (MsgVpnDistributedCacheClusterInstanceRestoreCachedMsgs) o;
    return Objects.equals(this.filename, msgVpnDistributedCacheClusterInstanceRestoreCachedMsgs.filename);
  }
  ...
  public String toString() {
    ...
    sb.append("class MsgVpnDistributedCacheClusterInstanceRestoreCachedMsgs {\n");
