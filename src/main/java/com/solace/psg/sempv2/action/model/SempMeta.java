...
import com.solace.psg.sempv2.action.model.SempError;
import com.solace.psg.sempv2.action.model.SempPaging;
import com.solace.psg.sempv2.action.model.SempRequest;
...
public class SempMeta {
  ...
  public SempMeta count(Long count) {
    this.count = count;
    return this;
  }
   ...
   * @return count
  **/
  @ApiModelProperty(value = "The total number of objects requested, irrespective of page size. This may be a count of all objects in a collection or a filtered subset. It represents a snapshot in time and may change when paging through results.")
  ...
  **/
   ...
   * @return responseCode
  **/
  @ApiModelProperty(required = true, value = "The HTTP response code, one of 200 (success), 4xx (client error), or 5xx (server error).")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.count, sempMeta.count) &&
        Objects.equals(this.error, sempMeta.error) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(count, error, paging, request, responseCode);
  }
