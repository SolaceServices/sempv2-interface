...
public class MsgVpnClientLinks {
  ...
  @SerializedName("disconnectUri")
  private String disconnectUri = null;
  ...
  public MsgVpnClientLinks clearEventUri(String clearEventUri) {
    this.clearEventUri = clearEventUri;
    return this;
  }

   /**
   * The URI of this Client&#39;s Clear Event action. Available since 2.12.
   * @return clearEventUri
  **/
  @ApiModelProperty(value = "The URI of this Client's Clear Event action. Available since 2.12.")
  ...
  public MsgVpnClientLinks clearStatsUri(String clearStatsUri) {
    this.clearStatsUri = clearStatsUri;
    return this;
  }

   /**
   * The URI of this Client&#39;s Clear Stats action.
   * @return clearStatsUri
  **/
  @ApiModelProperty(value = "The URI of this Client's Clear Stats action.")
  ...
  public MsgVpnClientLinks disconnectUri(String disconnectUri) {
    this.disconnectUri = disconnectUri;
    return this;
  }

   /**
   * The URI of this Client&#39;s Disconnect action.
   * @return disconnectUri
  **/
  @ApiModelProperty(value = "The URI of this Client's Disconnect action.")
  public String getDisconnectUri() {
    return disconnectUri;
  }

  public void setDisconnectUri(String disconnectUri) {
    this.disconnectUri = disconnectUri;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.clearEventUri, msgVpnClientLinks.clearEventUri) &&
        Objects.equals(this.clearStatsUri, msgVpnClientLinks.clearStatsUri) &&
        Objects.equals(this.disconnectUri, msgVpnClientLinks.disconnectUri) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(clearEventUri, clearStatsUri, disconnectUri, transactedSessionsUri, uri);
  }
  ...
  public String toString() {
    ...
    sb.append("    disconnectUri: ").append(toIndentedString(disconnectUri)).append("\n");
