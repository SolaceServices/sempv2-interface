...
public class MsgVpnClientLinks {
  ...
  **/
  @Schema(description = "The URI of this Client's Clear Event action. Available since 2.12.")
  ...
  **/
  @Schema(description = "The URI of this Client's Clear Stats action.")
  ...
  **/
  @Schema(description = "The URI of this Client's Disconnect action.")
