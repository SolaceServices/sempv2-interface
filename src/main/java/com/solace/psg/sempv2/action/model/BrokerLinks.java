...
public class BrokerLinks {
  ...
  **/
  @ApiModelProperty(value = "The URI of this Broker's collection of Certificate Authority objects.")
   ...
   * @return msgVpnsUri
  **/
  @ApiModelProperty(value = "The URI of this Broker's collection of Message VPN objects. Available since 2.11.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(aboutUri, certAuthoritiesUri, msgVpnsUri, uri);
  }
