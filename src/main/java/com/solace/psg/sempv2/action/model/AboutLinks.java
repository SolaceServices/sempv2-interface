...
public class AboutLinks {
  ...
  public AboutLinks uri(String uri) {
    this.uri = uri;
    return this;
  }
   ...
   * @return uri
  **/
  @ApiModelProperty(value = "The URI of this About object.")
  ...
  public AboutLinks userUri(String userUri) {
   ...
   * @return userUri
  **/
  @ApiModelProperty(value = "The URI of this About's User object. Available since 2.11.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.uri, aboutLinks.uri) &&
        Objects.equals(this.userUri, aboutLinks.userUri);
  }

  @Override
  public int hashCode() {
    return Objects.hash(uri, userUri);
  }
