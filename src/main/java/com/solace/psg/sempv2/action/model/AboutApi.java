...
public class AboutApi {
   ...
   * @return platform
  **/
  @ApiModelProperty(required = true, value = "The platform running the SEMP API.")
   ...
   * @return sempVersion
  **/
  @ApiModelProperty(required = true, value = "The version of the SEMP API.")
