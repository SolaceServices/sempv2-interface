...
public class MsgVpnRestDeliveryPointLinks {
  ...
  **/
  @Schema(description = "The URI of this REST Delivery Point's collection of REST Consumer objects.")
   ...
   * @return uri
  **/
  @Schema(description = "The URI of this REST Delivery Point object.")
