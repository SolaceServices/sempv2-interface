...
public class SempPaging {
   ...
   * @return cursorQuery
  **/
  @ApiModelProperty(required = true, value = "The cursor, or position, for the next page of objects. Use this as the `cursor` query parameter of the next request.")
   ...
   * @return nextPageUri
  **/
  @ApiModelProperty(required = true, value = "The URI of the next page of objects. `cursorQuery` is already embedded within this URI.")
