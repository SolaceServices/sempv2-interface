...
public class SempError {
   ...
   * @return code
  **/
  @ApiModelProperty(required = true, value = "The error code which uniquely identifies the error that has occurred.")
   ...
   * @return description
  **/
  @ApiModelProperty(required = true, value = "The verbose description of the problem.")
   ...
   * @return status
  **/
  @ApiModelProperty(required = true, value = "The terse status string associated with `code`.")
