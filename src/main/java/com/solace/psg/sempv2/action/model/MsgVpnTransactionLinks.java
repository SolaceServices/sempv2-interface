...
public class MsgVpnTransactionLinks {
   ...
   * @return commitUri
  **/
  @Schema(description = "The URI of this Replicated Local Transaction or XA Transaction's Commit action.")
   ...
   * @return deleteUri
  **/
  @Schema(description = "The URI of this Replicated Local Transaction or XA Transaction's Delete action.")
   ...
   * @return rollbackUri
  **/
  @Schema(description = "The URI of this Replicated Local Transaction or XA Transaction's Rollback action.")
   ...
   * @return uri
  **/
  @Schema(description = "The URI of this Replicated Local Transaction or XA Transaction object.")
