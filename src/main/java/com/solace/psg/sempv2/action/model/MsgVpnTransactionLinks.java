...
public class MsgVpnTransactionLinks {
  @SerializedName("commitUri")
  private String commitUri = null;

  @SerializedName("deleteUri")
  private String deleteUri = null;

  @SerializedName("rollbackUri")
  private String rollbackUri = null;

  @SerializedName("uri")
  private String uri = null;

  public MsgVpnTransactionLinks commitUri(String commitUri) {
    this.commitUri = commitUri;
    return this;
  }

   /**
   * The URI of this Replicated Local Transaction or XA Transaction&#39;s Commit action.
   * @return commitUri
  **/
  @ApiModelProperty(value = "The URI of this Replicated Local Transaction or XA Transaction's Commit action.")
  ...
  public MsgVpnTransactionLinks deleteUri(String deleteUri) {
    this.deleteUri = deleteUri;
    return this;
  }

   /**
   * The URI of this Replicated Local Transaction or XA Transaction&#39;s Delete action.
   * @return deleteUri
  **/
  @ApiModelProperty(value = "The URI of this Replicated Local Transaction or XA Transaction's Delete action.")
  ...
  public MsgVpnTransactionLinks rollbackUri(String rollbackUri) {
    this.rollbackUri = rollbackUri;
    return this;
  }

   /**
   * The URI of this Replicated Local Transaction or XA Transaction&#39;s Rollback action.
   * @return rollbackUri
  **/
  @ApiModelProperty(value = "The URI of this Replicated Local Transaction or XA Transaction's Rollback action.")
  ...
  public MsgVpnTransactionLinks uri(String uri) {
    this.uri = uri;
    return this;
  }
   ...
   * @return uri
  **/
  @ApiModelProperty(value = "The URI of this Replicated Local Transaction or XA Transaction object.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    MsgVpnTransactionLinks msgVpnTransactionLinks = (MsgVpnTransactionLinks) o;
    return Objects.equals(this.commitUri, msgVpnTransactionLinks.commitUri) &&
        Objects.equals(this.deleteUri, msgVpnTransactionLinks.deleteUri) &&
        Objects.equals(this.rollbackUri, msgVpnTransactionLinks.rollbackUri) &&
        Objects.equals(this.uri, msgVpnTransactionLinks.uri);
  }

  @Override
  public int hashCode() {
    return Objects.hash(commitUri, deleteUri, rollbackUri, uri);
  }
  ...
  public String toString() {
    ...
    sb.append("class MsgVpnTransactionLinks {\n");
    
    sb.append("    commitUri: ").append(toIndentedString(commitUri)).append("\n");
    sb.append("    deleteUri: ").append(toIndentedString(deleteUri)).append("\n");
    sb.append("    rollbackUri: ").append(toIndentedString(rollbackUri)).append("\n");
