...
public class MsgVpnDistributedCacheClusterInstanceBackupCachedMsgs {
  @SerializedName("filename")
  private String filename = null;

  public MsgVpnDistributedCacheClusterInstanceBackupCachedMsgs filename(String filename) {
    this.filename = filename;
    return this;
  }

   /**
   * The filename for storing the cached messages. This attribute is absent from a GET and not updated when absent in a PUT.
   * @return filename
  **/
  @ApiModelProperty(value = "The filename for storing the cached messages. This attribute is absent from a GET and not updated when absent in a PUT.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    MsgVpnDistributedCacheClusterInstanceBackupCachedMsgs msgVpnDistributedCacheClusterInstanceBackupCachedMsgs = (MsgVpnDistributedCacheClusterInstanceBackupCachedMsgs) o;
    return Objects.equals(this.filename, msgVpnDistributedCacheClusterInstanceBackupCachedMsgs.filename);
  }
  ...
  public String toString() {
    ...
    sb.append("class MsgVpnDistributedCacheClusterInstanceBackupCachedMsgs {\n");
