...
public class CertAuthorityLinks {
  @SerializedName("refreshCrlUri")
  private String refreshCrlUri = null;

  @SerializedName("uri")
  private String uri = null;

  public CertAuthorityLinks refreshCrlUri(String refreshCrlUri) {
    this.refreshCrlUri = refreshCrlUri;
    return this;
  }

   /**
   * The URI of this Certificate Authority&#39;s Refresh CRL action.
   * @return refreshCrlUri
  **/
  @ApiModelProperty(value = "The URI of this Certificate Authority's Refresh CRL action.")
  public String getRefreshCrlUri() {
    return refreshCrlUri;
  }

  public void setRefreshCrlUri(String refreshCrlUri) {
    this.refreshCrlUri = refreshCrlUri;
  }

  public CertAuthorityLinks uri(String uri) {
    this.uri = uri;
    return this;
  }
   ...
   * @return uri
  **/
  @ApiModelProperty(value = "The URI of this Certificate Authority object.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CertAuthorityLinks certAuthorityLinks = (CertAuthorityLinks) o;
    return Objects.equals(this.refreshCrlUri, certAuthorityLinks.refreshCrlUri) &&
        Objects.equals(this.uri, certAuthorityLinks.uri);
  }

  @Override
  public int hashCode() {
    return Objects.hash(refreshCrlUri, uri);
  }
  ...
  public String toString() {
    ...
    sb.append("class CertAuthorityLinks {\n");
    
    sb.append("    refreshCrlUri: ").append(toIndentedString(refreshCrlUri)).append("\n");
