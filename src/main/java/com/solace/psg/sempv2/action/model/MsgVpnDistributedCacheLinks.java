...
public class MsgVpnDistributedCacheLinks {
   ...
   * @return clustersUri
  **/
  @ApiModelProperty(value = "The URI of this Distributed Cache's collection of Cache Cluster objects.")
   ...
   * @return uri
  **/
  @ApiModelProperty(value = "The URI of this Distributed Cache object.")
