...
public class AboutUserMsgVpn {
   ...
   * @return accessLevel
  **/
  @ApiModelProperty(value = "The Message VPN access level of the User. The allowed values and their meaning are:  <pre> \"none\" - No access. \"read-only\" - Read only access. \"read-write\" - Read and write access. </pre> ")
