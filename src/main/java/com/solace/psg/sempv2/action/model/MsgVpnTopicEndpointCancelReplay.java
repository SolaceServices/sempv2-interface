...
public class MsgVpnTopicEndpointCancelReplay {
  @SerializedName("forceComplete")
  private Boolean forceComplete = null;

  public MsgVpnTopicEndpointCancelReplay forceComplete(Boolean forceComplete) {
    this.forceComplete = forceComplete;
    return this;
  }

   /**
   * Force cancellation to complete without waiting for client unbind ack. This attribute is absent from a GET and not updated when absent in a PUT.
   * @return forceComplete
  **/
  @ApiModelProperty(value = "Force cancellation to complete without waiting for client unbind ack. This attribute is absent from a GET and not updated when absent in a PUT.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    MsgVpnTopicEndpointCancelReplay msgVpnTopicEndpointCancelReplay = (MsgVpnTopicEndpointCancelReplay) o;
    return Objects.equals(this.forceComplete, msgVpnTopicEndpointCancelReplay.forceComplete);
  }

  @Override
  public int hashCode() {
    return Objects.hash(forceComplete);
  }
  ...
  public String toString() {
    ...
    sb.append("class MsgVpnTopicEndpointCancelReplay {\n");
    
    sb.append("    forceComplete: ").append(toIndentedString(forceComplete)).append("\n");
    sb.append("}");
    return sb.toString();
  }
