...
public class MsgVpnTopicEndpointCancelReplay {
  ...
  public MsgVpnTopicEndpointCancelReplay forceComplete(Boolean forceComplete) {
   ...
   /**
   * Force cancellation to complete without waiting for client unbind ack. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4.
   * @return forceComplete
  **/
  @Schema(description = "Force cancellation to complete without waiting for client unbind ack. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4.")
