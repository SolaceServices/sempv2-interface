...
public class MsgVpnBridgeClearEvent {
  /**
   * The name of the event. This attribute is absent from a GET and not updated when absent in a PUT. The allowed values and their meaning are:  &lt;pre&gt; \&quot;ttl-exceeded\&quot; - Time to live exceeded event. &lt;/pre&gt; 
   */
  ...
  public MsgVpnBridgeClearEvent eventName(EventNameEnum eventName) {
   ...
   * @return eventName
  **/
  @ApiModelProperty(value = "The name of the event. This attribute is absent from a GET and not updated when absent in a PUT. The allowed values and their meaning are:  <pre> \"ttl-exceeded\" - Time to live exceeded event. </pre> ")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    MsgVpnBridgeClearEvent msgVpnBridgeClearEvent = (MsgVpnBridgeClearEvent) o;
    return Objects.equals(this.eventName, msgVpnBridgeClearEvent.eventName);
  }
  ...
  public String toString() {
    ...
    sb.append("class MsgVpnBridgeClearEvent {\n");
