...
public class MsgVpnBridgeClearEvent {
  /**
   * The name of the event. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4. The allowed values and their meaning are:  &lt;pre&gt; \&quot;ttl-exceeded\&quot; - Time to live exceeded event. &lt;/pre&gt; 
   */
  @JsonAdapter(EventNameEnum.Adapter.class)
  public enum EventNameEnum {
    EXCEEDED("ttl-exceeded");
   ...
   * @return eventName
  **/
  @Schema(description = "The name of the event. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4. The allowed values and their meaning are:  <pre> \"ttl-exceeded\" - Time to live exceeded event. </pre> ")
