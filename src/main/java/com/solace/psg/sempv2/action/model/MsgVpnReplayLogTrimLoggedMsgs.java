...
public class MsgVpnReplayLogTrimLoggedMsgs {
  @SerializedName("olderThanTime")
  private Integer olderThanTime = null;

  public MsgVpnReplayLogTrimLoggedMsgs olderThanTime(Integer olderThanTime) {
    this.olderThanTime = olderThanTime;
    return this;
  }

   /**
   * The time to use for trimming older messages. This attribute is absent from a GET and not updated when absent in a PUT. This value represents the number of seconds since 1970-01-01 00:00:00 UTC (Unix time).
   * @return olderThanTime
  **/
  @ApiModelProperty(value = "The time to use for trimming older messages. This attribute is absent from a GET and not updated when absent in a PUT. This value represents the number of seconds since 1970-01-01 00:00:00 UTC (Unix time).")
  public Integer getOlderThanTime() {
    return olderThanTime;
  }

  public void setOlderThanTime(Integer olderThanTime) {
    this.olderThanTime = olderThanTime;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    MsgVpnReplayLogTrimLoggedMsgs msgVpnReplayLogTrimLoggedMsgs = (MsgVpnReplayLogTrimLoggedMsgs) o;
    return Objects.equals(this.olderThanTime, msgVpnReplayLogTrimLoggedMsgs.olderThanTime);
  }

  @Override
  public int hashCode() {
    return Objects.hash(olderThanTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class MsgVpnReplayLogTrimLoggedMsgs {\n");
    
    sb.append("    olderThanTime: ").append(toIndentedString(olderThanTime)).append("\n");
    sb.append("}");
    return sb.toString();
  }
