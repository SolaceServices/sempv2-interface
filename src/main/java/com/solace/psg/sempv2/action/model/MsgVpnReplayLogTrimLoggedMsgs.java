...
public class MsgVpnReplayLogTrimLoggedMsgs {
  ...
  public MsgVpnReplayLogTrimLoggedMsgs olderThanTime(Integer olderThanTime) {
   ...
   /**
   * The time to use for trimming older messages. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4. This value represents the number of seconds since 1970-01-01 00:00:00 UTC (Unix time).
   * @return olderThanTime
  **/
  @Schema(description = "The time to use for trimming older messages. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4. This value represents the number of seconds since 1970-01-01 00:00:00 UTC (Unix time).")
