...
public class MsgVpnBridgeLinks {
  ...
  **/
  @Schema(description = "The URI of this Bridge's Clear Event action.")
  ...
  **/
  @Schema(description = "The URI of this Bridge's Clear Stats action.")
  ...
  **/
  @Schema(description = "The URI of this Bridge's Disconnect action.")
   ...
   * @return uri
  **/
  @Schema(description = "The URI of this Bridge object.")
