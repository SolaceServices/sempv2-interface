...
public class MsgVpnClientClearEvent {
  /**
   * The name of the event. This attribute is absent from a GET and not updated when absent in a PUT. The allowed values and their meaning are:  &lt;pre&gt; \&quot;large-message\&quot; - The Client large message received event. \&quot;max-eliding-topic-count\&quot; - The Client maximum eliding topics reached event. &lt;/pre&gt; 
   */
  ...
  public enum EventNameEnum {
    ...
    public static class Adapter extends TypeAdapter<EventNameEnum> {
      ...
      public EventNameEnum read(final JsonReader jsonReader) throws IOException {
        ...
        return EventNameEnum.fromValue(String.valueOf(value));
      }
    }
  }
  ...
  public MsgVpnClientClearEvent eventName(EventNameEnum eventName) {
   ...
   * @return eventName
  **/
  @ApiModelProperty(value = "The name of the event. This attribute is absent from a GET and not updated when absent in a PUT. The allowed values and their meaning are:  <pre> \"large-message\" - The Client large message received event. \"max-eliding-topic-count\" - The Client maximum eliding topics reached event. </pre> ")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    MsgVpnClientClearEvent msgVpnClientClearEvent = (MsgVpnClientClearEvent) o;
    return Objects.equals(this.eventName, msgVpnClientClearEvent.eventName);
  }
  ...
  public String toString() {
    ...
    sb.append("class MsgVpnClientClearEvent {\n");
