...
public class MsgVpnClientClearEvent {
  /**
   * The name of the event. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4. The allowed values and their meaning are:  &lt;pre&gt; \&quot;large-message\&quot; - The Client large message received event. \&quot;max-eliding-topic-count\&quot; - The Client maximum eliding topics reached event. &lt;/pre&gt; 
   */
   ...
   * @return eventName
  **/
  @Schema(description = "The name of the event. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4. The allowed values and their meaning are:  <pre> \"large-message\" - The Client large message received event. \"max-eliding-topic-count\" - The Client maximum eliding topics reached event. </pre> ")
