...
public class MsgVpnTopicEndpointLinks {
  @SerializedName("cancelReplayUri")
  private String cancelReplayUri = null;

  @SerializedName("clearStatsUri")
  private String clearStatsUri = null;

  @SerializedName("msgsUri")
  private String msgsUri = null;

  @SerializedName("startReplayUri")
  private String startReplayUri = null;

  @SerializedName("uri")
  private String uri = null;

  public MsgVpnTopicEndpointLinks cancelReplayUri(String cancelReplayUri) {
    this.cancelReplayUri = cancelReplayUri;
    return this;
  }

   /**
   * The URI of this Topic Endpoint&#39;s Cancel Replay action.
   * @return cancelReplayUri
  **/
  @ApiModelProperty(value = "The URI of this Topic Endpoint's Cancel Replay action.")
  public String getCancelReplayUri() {
    return cancelReplayUri;
  }

  public void setCancelReplayUri(String cancelReplayUri) {
    this.cancelReplayUri = cancelReplayUri;
  }

  public MsgVpnTopicEndpointLinks clearStatsUri(String clearStatsUri) {
    this.clearStatsUri = clearStatsUri;
    return this;
  }

   /**
   * The URI of this Topic Endpoint&#39;s Clear Stats action.
   * @return clearStatsUri
  **/
  @ApiModelProperty(value = "The URI of this Topic Endpoint's Clear Stats action.")
  ...
  public MsgVpnTopicEndpointLinks msgsUri(String msgsUri) {
    this.msgsUri = msgsUri;
    return this;
  }
   ...
   * @return msgsUri
  **/
  @ApiModelProperty(value = "The URI of this Topic Endpoint's collection of Topic Endpoint Message objects.")
  public String getMsgsUri() {
    return msgsUri;
  }

  public void setMsgsUri(String msgsUri) {
    this.msgsUri = msgsUri;
  }

  public MsgVpnTopicEndpointLinks startReplayUri(String startReplayUri) {
    this.startReplayUri = startReplayUri;
    return this;
  }

   /**
   * The URI of this Topic Endpoint&#39;s Start Replay action.
   * @return startReplayUri
  **/
  @ApiModelProperty(value = "The URI of this Topic Endpoint's Start Replay action.")
  public String getStartReplayUri() {
    return startReplayUri;
  }

  public void setStartReplayUri(String startReplayUri) {
    this.startReplayUri = startReplayUri;
  }
   ...
   * @return uri
  **/
  @ApiModelProperty(value = "The URI of this Topic Endpoint object.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.cancelReplayUri, msgVpnTopicEndpointLinks.cancelReplayUri) &&
        Objects.equals(this.clearStatsUri, msgVpnTopicEndpointLinks.clearStatsUri) &&
        Objects.equals(this.msgsUri, msgVpnTopicEndpointLinks.msgsUri) &&
        Objects.equals(this.startReplayUri, msgVpnTopicEndpointLinks.startReplayUri) &&
        Objects.equals(this.uri, msgVpnTopicEndpointLinks.uri);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cancelReplayUri, clearStatsUri, msgsUri, startReplayUri, uri);
  }
  ...
  public String toString() {
    ...
    sb.append("    cancelReplayUri: ").append(toIndentedString(cancelReplayUri)).append("\n");
    sb.append("    clearStatsUri: ").append(toIndentedString(clearStatsUri)).append("\n");
    sb.append("    msgsUri: ").append(toIndentedString(msgsUri)).append("\n");
    sb.append("    startReplayUri: ").append(toIndentedString(startReplayUri)).append("\n");
