...
public class MsgVpnTopicEndpointLinks {
  ...
  **/
  @Schema(description = "The URI of this Topic Endpoint's Cancel Replay action.")
  ...
  **/
  @Schema(description = "The URI of this Topic Endpoint's Clear Stats action.")
   ...
   * @return msgsUri
  **/
  @Schema(description = "The URI of this Topic Endpoint's collection of Topic Endpoint Message objects.")
  ...
  **/
  @Schema(description = "The URI of this Topic Endpoint's Start Replay action.")
   ...
   * @return uri
  **/
  @Schema(description = "The URI of this Topic Endpoint object.")
