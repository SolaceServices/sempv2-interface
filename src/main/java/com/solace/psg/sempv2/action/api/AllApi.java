...
public class AllApi {
     ...
     */
    public com.squareup.okhttp.Call doCertAuthorityRefreshCrlCall(CertAuthorityRefreshCrl body, String certAuthorityName, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call doCertAuthorityRefreshCrlValidateBeforeCall(CertAuthorityRefreshCrl body, String certAuthorityName, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = doCertAuthorityRefreshCrlCall(body, certAuthorityName, progressListener, progressRequestListener);
        return call;
     ...
     */
    public SempMetaOnlyResponse doCertAuthorityRefreshCrl(CertAuthorityRefreshCrl body, String certAuthorityName) throws ApiException {
        ApiResponse<SempMetaOnlyResponse> resp = doCertAuthorityRefreshCrlWithHttpInfo(body, certAuthorityName);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<SempMetaOnlyResponse> doCertAuthorityRefreshCrlWithHttpInfo(CertAuthorityRefreshCrl body, String certAuthorityName) throws ApiException {
        com.squareup.okhttp.Call call = doCertAuthorityRefreshCrlValidateBeforeCall(body, certAuthorityName, null, null);
     ...
     */
    public com.squareup.okhttp.Call doCertAuthorityRefreshCrlAsync(CertAuthorityRefreshCrl body, String certAuthorityName, final ApiCallback<SempMetaOnlyResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = doCertAuthorityRefreshCrlValidateBeforeCall(body, certAuthorityName, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<SempMetaOnlyResponse>(){}.getType();
