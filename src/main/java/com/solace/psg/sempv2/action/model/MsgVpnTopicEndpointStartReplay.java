...
public class MsgVpnTopicEndpointStartReplay {
  ...
  public MsgVpnTopicEndpointStartReplay fromTime(Integer fromTime) {
    this.fromTime = fromTime;
    return this;
  }

   /**
   * The time to begin replaying messages from. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4. This value represents the number of seconds since 1970-01-01 00:00:00 UTC (Unix time).
   * @return fromTime
  **/
  @Schema(description = "The time to begin replaying messages from. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4. This value represents the number of seconds since 1970-01-01 00:00:00 UTC (Unix time).")
  ...
  public MsgVpnTopicEndpointStartReplay replayLogName(String replayLogName) {
    this.replayLogName = replayLogName;
    return this;
  }

   /**
   * The name of the Replay Log. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4.
   * @return replayLogName
  **/
  @Schema(description = "The name of the Replay Log. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    MsgVpnTopicEndpointStartReplay msgVpnTopicEndpointStartReplay = (MsgVpnTopicEndpointStartReplay) o;
    return Objects.equals(this.fromTime, msgVpnTopicEndpointStartReplay.fromTime) &&
        Objects.equals(this.replayLogName, msgVpnTopicEndpointStartReplay.replayLogName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fromTime, replayLogName);
  }
  ...
  public String toString() {
    ...
    sb.append("class MsgVpnTopicEndpointStartReplay {\n");
