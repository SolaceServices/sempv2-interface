...
public class MsgVpnTopicEndpointStartReplay {
  ...
  public MsgVpnTopicEndpointStartReplay fromTime(Integer fromTime) {
   ...
   /**
   * The time to begin replaying messages from. This attribute is absent from a GET and not updated when absent in a PUT. This value represents the number of seconds since 1970-01-01 00:00:00 UTC (Unix time).
   * @return fromTime
  **/
  @ApiModelProperty(value = "The time to begin replaying messages from. This attribute is absent from a GET and not updated when absent in a PUT. This value represents the number of seconds since 1970-01-01 00:00:00 UTC (Unix time).")
  ...
  public MsgVpnTopicEndpointStartReplay replayLogName(String replayLogName) {
   ...
   /**
   * The name of the Replay Log. This attribute is absent from a GET and not updated when absent in a PUT.
   * @return replayLogName
  **/
  @ApiModelProperty(value = "The name of the Replay Log. This attribute is absent from a GET and not updated when absent in a PUT.")
