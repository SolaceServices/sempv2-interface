...
public class MsgVpnDistributedCacheClusterInstanceDeleteMsgs {
  ...
  public MsgVpnDistributedCacheClusterInstanceDeleteMsgs topic(String topic) {
   ...
   /**
   * The topic covering the messages to delete. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4.
   * @return topic
  **/
  @Schema(description = "The topic covering the messages to delete. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4.")
