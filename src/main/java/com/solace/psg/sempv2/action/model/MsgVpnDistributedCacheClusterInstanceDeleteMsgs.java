...
public class MsgVpnDistributedCacheClusterInstanceDeleteMsgs {
  @SerializedName("topic")
  private String topic = null;

  public MsgVpnDistributedCacheClusterInstanceDeleteMsgs topic(String topic) {
    this.topic = topic;
    return this;
  }

   /**
   * The topic covering the messages to delete. This attribute is absent from a GET and not updated when absent in a PUT.
   * @return topic
  **/
  @ApiModelProperty(value = "The topic covering the messages to delete. This attribute is absent from a GET and not updated when absent in a PUT.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    MsgVpnDistributedCacheClusterInstanceDeleteMsgs msgVpnDistributedCacheClusterInstanceDeleteMsgs = (MsgVpnDistributedCacheClusterInstanceDeleteMsgs) o;
    return Objects.equals(this.topic, msgVpnDistributedCacheClusterInstanceDeleteMsgs.topic);
  }
  ...
  public String toString() {
    ...
    sb.append("class MsgVpnDistributedCacheClusterInstanceDeleteMsgs {\n");
