...
public class MsgVpnReplayLog {
  ...
  **/
  @Schema(description = "Enable or disable the transmission of messages from the Replay Log. The default value is `false`.")
  ...
  **/
  @Schema(description = "Enable or disable the reception of messages to the Replay Log. The default value is `false`.")
  ...
  **/
  @Schema(description = "The maximum spool usage allowed by the Replay Log, in megabytes (MB). If this limit is exceeded, old messages will be trimmed. The default value is `0`.")
