...
public class ClientProfileApi {
     ...
     */
    public com.squareup.okhttp.Call createMsgVpnClientProfileCall(String msgVpnName, MsgVpnClientProfile body, List<String> select, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call createMsgVpnClientProfileValidateBeforeCall(String msgVpnName, MsgVpnClientProfile body, List<String> select, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<MsgVpnClientProfileResponse> createMsgVpnClientProfileWithHttpInfo(String msgVpnName, MsgVpnClientProfile body, List<String> select) throws ApiException {
        com.squareup.okhttp.Call call = createMsgVpnClientProfileValidateBeforeCall(msgVpnName, body, select, null, null);
    ...
    public com.squareup.okhttp.Call createMsgVpnClientProfileAsync(String msgVpnName, MsgVpnClientProfile body, List<String> select, final ApiCallback<MsgVpnClientProfileResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createMsgVpnClientProfileValidateBeforeCall(msgVpnName, body, select, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<MsgVpnClientProfileResponse>(){}.getType();
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call replaceMsgVpnClientProfileCall(String msgVpnName, String clientProfileName, MsgVpnClientProfile body, List<String> select, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    public ApiResponse<MsgVpnClientProfileResponse> replaceMsgVpnClientProfileWithHttpInfo(String msgVpnName, String clientProfileName, MsgVpnClientProfile body, List<String> select) throws ApiException {
        com.squareup.okhttp.Call call = replaceMsgVpnClientProfileValidateBeforeCall(msgVpnName, clientProfileName, body, select, null, null);
        Type localVarReturnType = new TypeToken<MsgVpnClientProfileResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    public com.squareup.okhttp.Call replaceMsgVpnClientProfileAsync(String msgVpnName, String clientProfileName, MsgVpnClientProfile body, List<String> select, final ApiCallback<MsgVpnClientProfileResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = replaceMsgVpnClientProfileValidateBeforeCall(msgVpnName, clientProfileName, body, select, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<MsgVpnClientProfileResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call updateMsgVpnClientProfileCall(String msgVpnName, String clientProfileName, MsgVpnClientProfile body, List<String> select, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateMsgVpnClientProfileValidateBeforeCall(String msgVpnName, String clientProfileName, MsgVpnClientProfile body, List<String> select, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<MsgVpnClientProfileResponse> updateMsgVpnClientProfileWithHttpInfo(String msgVpnName, String clientProfileName, MsgVpnClientProfile body, List<String> select) throws ApiException {
        com.squareup.okhttp.Call call = updateMsgVpnClientProfileValidateBeforeCall(msgVpnName, clientProfileName, body, select, null, null);
        Type localVarReturnType = new TypeToken<MsgVpnClientProfileResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    public com.squareup.okhttp.Call updateMsgVpnClientProfileAsync(String msgVpnName, String clientProfileName, MsgVpnClientProfile body, List<String> select, final ApiCallback<MsgVpnClientProfileResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateMsgVpnClientProfileValidateBeforeCall(msgVpnName, clientProfileName, body, select, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<MsgVpnClientProfileResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
