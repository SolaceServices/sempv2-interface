...
public class MsgVpnLinks {
  ...
  **/
  @Schema(description = "The URI of this Message VPN's collection of Distributed Cache objects. Available since 2.11.")
  ...
  **/
  @Schema(description = "The URI of this Message VPN's collection of DMR Bridge objects. Available since 2.11.")
  ...
  **/
  @Schema(description = "The URI of this Message VPN's collection of JNDI Connection Factory objects. Available since 2.2.")
  ...
  **/
  @Schema(description = "The URI of this Message VPN's collection of JNDI Queue objects. Available since 2.2.")
  ...
  **/
  @Schema(description = "The URI of this Message VPN's collection of JNDI Topic objects. Available since 2.2.")
  ...
  **/
  @Schema(description = "The URI of this Message VPN's collection of MQTT Retain Cache objects. Available since 2.11.")
  ...
  **/
  @Schema(description = "The URI of this Message VPN's collection of MQTT Session objects. Available since 2.1.")
  ...
  **/
  @Schema(description = "The URI of this Message VPN's collection of Replay Log objects. Available since 2.10.")
  ...
  **/
  @Schema(description = "The URI of this Message VPN's collection of Replicated Topic objects. Available since 2.1.")
  ...
  **/
  @Schema(description = "The URI of this Message VPN's collection of Sequenced Topic objects.")
  ...
  **/
  @Schema(description = "The URI of this Message VPN's collection of Topic Endpoint objects. Available since 2.1.")
