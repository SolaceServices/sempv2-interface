...
public class QueueApi 
{
     ...
     */
    public com.squareup.okhttp.Call createMsgVpnQueueCall(String msgVpnName, MsgVpnQueue body, List<String> select, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call createMsgVpnQueueValidateBeforeCall(String msgVpnName, MsgVpnQueue body, List<String> select, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<MsgVpnQueueResponse> createMsgVpnQueueWithHttpInfo(String msgVpnName, MsgVpnQueue body, List<String> select) throws ApiException {
        com.squareup.okhttp.Call call = createMsgVpnQueueValidateBeforeCall(msgVpnName, body, select, null, null);
    ...
    public com.squareup.okhttp.Call createMsgVpnQueueAsync(String msgVpnName, MsgVpnQueue body, List<String> select, final ApiCallback<MsgVpnQueueResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createMsgVpnQueueValidateBeforeCall(msgVpnName, body, select, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<MsgVpnQueueResponse>(){}.getType();
    ...
    public ApiResponse<MsgVpnQueueSubscriptionResponse> createMsgVpnQueueSubscriptionWithHttpInfo(String msgVpnName, String queueName, MsgVpnQueueSubscription body, List<String> select) throws ApiException {
        com.squareup.okhttp.Call call = createMsgVpnQueueSubscriptionValidateBeforeCall(msgVpnName, queueName, body, select, null, null);
    ...
    public com.squareup.okhttp.Call createMsgVpnQueueSubscriptionAsync(String msgVpnName, String queueName, MsgVpnQueueSubscription body, List<String> select, final ApiCallback<MsgVpnQueueSubscriptionResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createMsgVpnQueueSubscriptionValidateBeforeCall(msgVpnName, queueName, body, select, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<MsgVpnQueueSubscriptionResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call replaceMsgVpnQueueCall(String msgVpnName, String queueName, MsgVpnQueue body, List<String> select, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call replaceMsgVpnQueueValidateBeforeCall(String msgVpnName, String queueName, MsgVpnQueue body, List<String> select, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<MsgVpnQueueResponse> replaceMsgVpnQueueWithHttpInfo(String msgVpnName, String queueName, MsgVpnQueue body, List<String> select) throws ApiException {
        com.squareup.okhttp.Call call = replaceMsgVpnQueueValidateBeforeCall(msgVpnName, queueName, body, select, null, null);
        Type localVarReturnType = new TypeToken<MsgVpnQueueResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    public com.squareup.okhttp.Call replaceMsgVpnQueueAsync(String msgVpnName, String queueName, MsgVpnQueue body, List<String> select, final ApiCallback<MsgVpnQueueResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = replaceMsgVpnQueueValidateBeforeCall(msgVpnName, queueName, body, select, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<MsgVpnQueueResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call updateMsgVpnQueueCall(String msgVpnName, String queueName, MsgVpnQueue body, List<String> select, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateMsgVpnQueueValidateBeforeCall(String msgVpnName, String queueName, MsgVpnQueue body, List<String> select, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<MsgVpnQueueResponse> updateMsgVpnQueueWithHttpInfo(String msgVpnName, String queueName, MsgVpnQueue body, List<String> select) throws ApiException {
        com.squareup.okhttp.Call call = updateMsgVpnQueueValidateBeforeCall(msgVpnName, queueName, body, select, null, null);
        Type localVarReturnType = new TypeToken<MsgVpnQueueResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    public com.squareup.okhttp.Call updateMsgVpnQueueAsync(String msgVpnName, String queueName, MsgVpnQueue body, List<String> select, final ApiCallback<MsgVpnQueueResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateMsgVpnQueueValidateBeforeCall(msgVpnName, queueName, body, select, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<MsgVpnQueueResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
