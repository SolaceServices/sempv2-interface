...
public class MsgVpnTopicEndpointTemplate {
  /**
  ...
  @SerializedName("topicEndpointNameFilter")
  private String topicEndpointNameFilter = null;

  @SerializedName("topicEndpointTemplateName")
  private String topicEndpointTemplateName = null;

  public MsgVpnTopicEndpointTemplate accessType(AccessTypeEnum accessType) {
   ...
   * @return accessType
  **/
  @Schema(description = "The access type for delivering messages to consumer flows. The default value is `\"exclusive\"`. The allowed values and their meaning are:  <pre> \"exclusive\" - Exclusive delivery of messages to the first bound consumer flow. \"non-exclusive\" - Non-exclusive delivery of messages to all bound consumer flows in a round-robin fashion. </pre> ")
  ...
  public MsgVpnTopicEndpointTemplate consumerAckPropagationEnabled(Boolean consumerAckPropagationEnabled) {
  ...
  **/
  ...
  public MsgVpnTopicEndpointTemplate deadMsgQueue(String deadMsgQueue) {
   ...
   * @return deadMsgQueue
  **/
  @Schema(description = "The name of the Dead Message Queue (DMQ). The default value is `\"#DEAD_MSG_QUEUE\"`.")
  ...
  public MsgVpnTopicEndpointTemplate eventBindCountThreshold(EventThreshold eventBindCountThreshold) {
  ...
  **/
  ...
  public MsgVpnTopicEndpointTemplate eventMsgSpoolUsageThreshold(EventThreshold eventMsgSpoolUsageThreshold) {
  ...
  **/
  ...
  public MsgVpnTopicEndpointTemplate maxBindCount(Long maxBindCount) {
   ...
   * @return maxBindCount
  **/
  @Schema(description = "The maximum number of consumer flows that can bind. The default value is `1`.")
  ...
  public MsgVpnTopicEndpointTemplate maxDeliveredUnackedMsgsPerFlow(Long maxDeliveredUnackedMsgsPerFlow) {
  ...
  **/
  @Schema(description = "The maximum number of messages delivered but not acknowledged per flow. The default value is `10000`.")
  ...
  public MsgVpnTopicEndpointTemplate maxMsgSize(Integer maxMsgSize) {
   ...
   * @return maxMsgSize
  **/
  @Schema(description = "The maximum message size allowed, in bytes (B). The default value is `10000000`.")
  ...
  public MsgVpnTopicEndpointTemplate maxMsgSpoolUsage(Long maxMsgSpoolUsage) {
  ...
  **/
  @Schema(description = "The maximum message spool usage allowed, in megabytes (MB). A value of 0 only allows spooling of the last message received and disables quota checking. The default value is `1500`.")
  ...
  public MsgVpnTopicEndpointTemplate maxRedeliveryCount(Long maxRedeliveryCount) {
  ...
  **/
  @Schema(description = "The maximum number of message redelivery attempts that will occur prior to the message being discarded or moved to the DMQ. A value of 0 means to retry forever. The default value is `0`.")
  ...
  public MsgVpnTopicEndpointTemplate maxTtl(Long maxTtl) {
    this.maxTtl = maxTtl;
    return this;
  }
  ...
  **/
  ...
  public MsgVpnTopicEndpointTemplate msgVpnName(String msgVpnName) {
  ...
  **/
  ...
  public MsgVpnTopicEndpointTemplate permission(PermissionEnum permission) {
  ...
  **/
  ...
  public MsgVpnTopicEndpointTemplate rejectLowPriorityMsgEnabled(Boolean rejectLowPriorityMsgEnabled) {
  ...
  **/
  ...
  public MsgVpnTopicEndpointTemplate rejectLowPriorityMsgLimit(Long rejectLowPriorityMsgLimit) {
  ...
  **/
  @Schema(description = "The number of messages that are permitted before low priority messages are rejected. The default value is `0`.")
  ...
  public MsgVpnTopicEndpointTemplate rejectMsgToSenderOnDiscardBehavior(RejectMsgToSenderOnDiscardBehaviorEnum rejectMsgToSenderOnDiscardBehavior) {
  ...
  **/
  ...
  public MsgVpnTopicEndpointTemplate respectMsgPriorityEnabled(Boolean respectMsgPriorityEnabled) {
  ...
  **/
  @Schema(description = "Enable or disable the respecting of message priority. When enabled, messages are delivered in priority order, from 9 (highest) to 0 (lowest). The default value is `false`.")
  ...
  public MsgVpnTopicEndpointTemplate respectTtlEnabled(Boolean respectTtlEnabled) {
  ...
  **/
  @Schema(description = "Enable or disable the respecting of the time-to-live (TTL) for messages. When enabled, expired messages are discarded or moved to the DMQ. The default value is `false`.")
  ...
  public MsgVpnTopicEndpointTemplate topicEndpointNameFilter(String topicEndpointNameFilter) {
    this.topicEndpointNameFilter = topicEndpointNameFilter;
    return this;
  }
   ...
   * @return topicEndpointNameFilter
  **/
  @Schema(description = "A wildcardable pattern used to determine which Topic Endpoints use settings from this Template. Two different wildcards are supported: * and >. Similar to topic filters or subscription patterns, a > matches anything (but only when used at the end), and a * matches zero or more characters but never a slash (/). A > is only a wildcard when used at the end, after a /. A * is only allowed at the end, after a slash (/). The default value is `\"\"`.")
  public String getTopicEndpointNameFilter() {
    return topicEndpointNameFilter;
  }

  public void setTopicEndpointNameFilter(String topicEndpointNameFilter) {
    this.topicEndpointNameFilter = topicEndpointNameFilter;
  }

  public MsgVpnTopicEndpointTemplate topicEndpointTemplateName(String topicEndpointTemplateName) {
    this.topicEndpointTemplateName = topicEndpointTemplateName;
    return this;
  }

   /**
   * The name of the Topic Endpoint Template.
   * @return topicEndpointTemplateName
  **/
  @Schema(description = "The name of the Topic Endpoint Template.")
  public String getTopicEndpointTemplateName() {
    return topicEndpointTemplateName;
  }

  public void setTopicEndpointTemplateName(String topicEndpointTemplateName) {
    this.topicEndpointTemplateName = topicEndpointTemplateName;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    MsgVpnTopicEndpointTemplate msgVpnTopicEndpointTemplate = (MsgVpnTopicEndpointTemplate) o;
    return Objects.equals(this.accessType, msgVpnTopicEndpointTemplate.accessType) &&
        Objects.equals(this.consumerAckPropagationEnabled, msgVpnTopicEndpointTemplate.consumerAckPropagationEnabled) &&
        Objects.equals(this.deadMsgQueue, msgVpnTopicEndpointTemplate.deadMsgQueue) &&
        Objects.equals(this.eventBindCountThreshold, msgVpnTopicEndpointTemplate.eventBindCountThreshold) &&
        Objects.equals(this.eventMsgSpoolUsageThreshold, msgVpnTopicEndpointTemplate.eventMsgSpoolUsageThreshold) &&
        Objects.equals(this.eventRejectLowPriorityMsgLimitThreshold, msgVpnTopicEndpointTemplate.eventRejectLowPriorityMsgLimitThreshold) &&
        Objects.equals(this.maxBindCount, msgVpnTopicEndpointTemplate.maxBindCount) &&
        Objects.equals(this.maxDeliveredUnackedMsgsPerFlow, msgVpnTopicEndpointTemplate.maxDeliveredUnackedMsgsPerFlow) &&
        Objects.equals(this.maxMsgSize, msgVpnTopicEndpointTemplate.maxMsgSize) &&
        Objects.equals(this.maxMsgSpoolUsage, msgVpnTopicEndpointTemplate.maxMsgSpoolUsage) &&
        Objects.equals(this.maxRedeliveryCount, msgVpnTopicEndpointTemplate.maxRedeliveryCount) &&
        Objects.equals(this.maxTtl, msgVpnTopicEndpointTemplate.maxTtl) &&
        Objects.equals(this.msgVpnName, msgVpnTopicEndpointTemplate.msgVpnName) &&
        Objects.equals(this.permission, msgVpnTopicEndpointTemplate.permission) &&
        Objects.equals(this.rejectLowPriorityMsgEnabled, msgVpnTopicEndpointTemplate.rejectLowPriorityMsgEnabled) &&
        Objects.equals(this.rejectLowPriorityMsgLimit, msgVpnTopicEndpointTemplate.rejectLowPriorityMsgLimit) &&
        Objects.equals(this.rejectMsgToSenderOnDiscardBehavior, msgVpnTopicEndpointTemplate.rejectMsgToSenderOnDiscardBehavior) &&
        Objects.equals(this.respectMsgPriorityEnabled, msgVpnTopicEndpointTemplate.respectMsgPriorityEnabled) &&
        Objects.equals(this.respectTtlEnabled, msgVpnTopicEndpointTemplate.respectTtlEnabled) &&
        Objects.equals(this.topicEndpointNameFilter, msgVpnTopicEndpointTemplate.topicEndpointNameFilter) &&
        Objects.equals(this.topicEndpointTemplateName, msgVpnTopicEndpointTemplate.topicEndpointTemplateName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accessType, consumerAckPropagationEnabled, deadMsgQueue, eventBindCountThreshold, eventMsgSpoolUsageThreshold, eventRejectLowPriorityMsgLimitThreshold, maxBindCount, maxDeliveredUnackedMsgsPerFlow, maxMsgSize, maxMsgSpoolUsage, maxRedeliveryCount, maxTtl, msgVpnName, permission, rejectLowPriorityMsgEnabled, rejectLowPriorityMsgLimit, rejectMsgToSenderOnDiscardBehavior, respectMsgPriorityEnabled, respectTtlEnabled, topicEndpointNameFilter, topicEndpointTemplateName);
  }
  ...
  public String toString() {
    ...
    sb.append("class MsgVpnTopicEndpointTemplate {\n");
