...
public class MsgVpnTopicEndpointTemplate {
  ...
  **/
   ...
   * @return maxBindCount
  **/
  @ApiModelProperty(value = "The maximum number of consumer flows that can bind. The default value is `1`.")
  ...
  **/
  @ApiModelProperty(value = "The number of messages that are permitted before low priority messages are rejected. The default value is `0`.")
