...
public class MsgVpnDistributedCacheCluster {
  ...
  **/
  @ApiModelProperty(value = "Enable or disable deliver-to-one override for the Cache Cluster. The default value is `true`.")
   ...
   * @return enabled
  **/
  @ApiModelProperty(value = "Enable or disable the Cache Cluster. The default value is `false`.")
  ...
  **/
  @ApiModelProperty(value = "Enable or disable global caching for the Cache Cluster. When enabled, the Cache Instances will fetch topics from remote Home Cache Clusters when requested, and subscribe to those topics to cache them locally. When disabled, the Cache Instances will remove all subscriptions and cached messages for topics from remote Home Cache Clusters. The default value is `false`.")
  ...
  **/
  @ApiModelProperty(value = "The heartbeat interval, in seconds, used by the Cache Instances to monitor connectivity with the remote Home Cache Clusters. The default value is `3`.")
  ...
  **/
  @ApiModelProperty(value = "The topic lifetime, in seconds. If no client requests are received for a given global topic over the duration of the topic lifetime, then the Cache Instance will remove the subscription and cached messages for that topic. A value of 0 disables aging. The default value is `3600`.")
   ...
   * @return maxMemory
  **/
  @ApiModelProperty(value = "The maximum memory usage, in megabytes (MB), for each Cache Instance in the Cache Cluster. The default value is `2048`.")
  ...
  **/
  @ApiModelProperty(value = "The maximum number of messages per topic for each Cache Instance in the Cache Cluster. When at the maximum, old messages are removed as new messages arrive. The default value is `1`.")
  ...
  **/
  @ApiModelProperty(value = "The maximum queue depth for cache requests received by the Cache Cluster. The default value is `100000`.")
  ...
  **/
  @ApiModelProperty(value = "The maximum number of topics for each Cache Instance in the Cache Cluster. The default value is `2000000`.")
   ...
   * @return msgLifetime
  **/
  @ApiModelProperty(value = "The message lifetime, in seconds. If a message remains cached for the duration of its lifetime, the Cache Instance will remove the message. A lifetime of 0 results in the message being retained indefinitely. The default is to have no `msgLifetime`.")
  ...
  **/
  @ApiModelProperty(value = "Enable or disable the advertising, onto the message bus, of new topics learned by each Cache Instance in the Cache Cluster. The default value is `false`.")
