...
public class MsgVpnClientUsername {
  ...
  **/
  @ApiModelProperty(value = "The ACL Profile of the Client Username. The default value is `\"default\"`.")
  ...
  **/
  @ApiModelProperty(value = "The Client Profile of the Client Username. The default value is `\"default\"`.")
  ...
  **/
  @ApiModelProperty(value = "The name of the Client Username.")
   ...
   * @return enabled
  **/
  @ApiModelProperty(value = "Enable or disable the Client Username. When disabled, all clients currently connected as the Client Username are disconnected. The default value is `false`.")
  ...
  **/
  @ApiModelProperty(value = "Enable or disable guaranteed endpoint permission override for the Client Username. When enabled all guaranteed endpoints may be accessed, modified or deleted with the same permission as the owner. The default value is `false`.")
  public Boolean isGuaranteedEndpointPermissionOverrideEnabled() {
    return guaranteedEndpointPermissionOverrideEnabled;
  }
  ...
  **/
  @ApiModelProperty(value = "Enable or disable the subscription management capability of the Client Username. This is the ability to manage subscriptions on behalf of other Client Usernames. The default value is `false`.")
