...
public class MsgVpnClientUsername {
  ...
  **/
  @Schema(description = "The ACL Profile of the Client Username. The default value is `\"default\"`.")
  ...
  **/
  @Schema(description = "The Client Profile of the Client Username. The default value is `\"default\"`.")
  ...
  **/
   ...
   * @return enabled
  **/
  @Schema(description = "Enable or disable the Client Username. When disabled, all clients currently connected as the Client Username are disconnected. The default value is `false`.")
  ...
  **/
  @Schema(description = "Enable or disable guaranteed endpoint permission override for the Client Username. When enabled all guaranteed endpoints may be accessed, modified or deleted with the same permission as the owner. The default value is `false`.")
  ...
  **/
  @Schema(description = "Enable or disable the subscription management capability of the Client Username. This is the ability to manage subscriptions on behalf of other Client Usernames. The default value is `false`.")
