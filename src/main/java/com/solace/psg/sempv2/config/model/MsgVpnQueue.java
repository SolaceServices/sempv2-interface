...
public class MsgVpnQueue {
   ...
   * @return accessType
  **/
  @ApiModelProperty(value = "The access type for delivering messages to consumer flows bound to the Queue. The default value is `\"exclusive\"`. The allowed values and their meaning are:  <pre> \"exclusive\" - Exclusive delivery of messages to the first bound consumer flow. \"non-exclusive\" - Non-exclusive delivery of messages to all bound consumer flows in a round-robin fashion. </pre> ")
  ...
  **/
   ...
   * @return deadMsgQueue
  **/
  @ApiModelProperty(value = "The name of the Dead Message Queue (DMQ) used by the Queue. The default value is `\"#DEAD_MSG_QUEUE\"`.")
  ...
  **/
  @ApiModelProperty(value = "Enable or disable the transmission of messages from the Queue. The default value is `false`.")
  ...
  **/
  @ApiModelProperty(value = "Enable or disable the reception of messages to the Queue. The default value is `false`.")
   ...
   * @return maxBindCount
  **/
  @ApiModelProperty(value = "The maximum number of consumer flows that can bind to the Queue. The default value is `1000`.")
  ...
  **/
  @ApiModelProperty(value = "The maximum number of messages delivered but not acknowledged per flow for the Queue. The default value is `10000`.")
   ...
   * @return maxMsgSize
  **/
  @ApiModelProperty(value = "The maximum message size allowed in the Queue, in bytes (B). The default value is `10000000`.")
  ...
  **/
  @ApiModelProperty(value = "The maximum message spool usage allowed by the Queue, in megabytes (MB). A value of 0 only allows spooling of the last message received and disables quota checking. The default varies by platform.")
  ...
  **/
   ...
   * @return owner
  **/
  @ApiModelProperty(value = "The Client Username that owns the Queue and has permission equivalent to `\"delete\"`. The default value is `\"\"`.")
  ...
  **/
  @ApiModelProperty(value = "The number of messages of any priority in the Queue above which low priority messages are not admitted but higher priority messages are allowed. The default value is `0`.")
  ...
  **/
  @ApiModelProperty(value = "Enable or disable the respecting of message priority. When enabled, messages contained in the Queue are delivered in priority order, from 9 (highest) to 0 (lowest). MQTT queues do not support enabling message priority. The default value is `false`. Available since 2.8.")
