...
public class MsgVpnMqttSessionSubscription {
  ...
  **/
  @Schema(description = "The quality of service (QoS) for the subscription as either 0 (deliver at most once) or 1 (deliver at least once). QoS 2 is not supported, but QoS 2 messages attracted by QoS 0 or QoS 1 subscriptions are accepted and delivered accordingly. The default value is `0`.")
  ...
  **/
  @Schema(description = "The MQTT subscription topic.")
