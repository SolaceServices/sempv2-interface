...
public class MsgVpnBridgeRemoteSubscription {
  ...
  **/
  @ApiModelProperty(value = "Enable or disable deliver-always for the Bridge remote subscription topic instead of a deliver-to-one remote priority. A given topic for the Bridge may be deliver-to-one or deliver-always but not both.")
