...
public class MsgVpnDistributedCacheClusterInstance {
  ...
  **/
  @Schema(description = "Enable or disable auto-start for the Cache Instance. When enabled, the Cache Instance will automatically attempt to transition from the Stopped operational state to Up whenever it restarts or reconnects to the message broker. The default value is `false`.")
  ...
  **/
   ...
   * @return enabled
  **/
  @Schema(description = "Enable or disable the Cache Instance. The default value is `false`.")
  ...
  **/
  @Schema(description = "Enable or disable stop-on-lost-message for the Cache Instance. When enabled, the Cache Instance will transition to the stopped operational state upon losing a message. When stopped, it cannot accept or respond to cache requests, but continues to cache messages. The default value is `true`.")
