...
public class MsgVpnBridgeRemoteMsgVpn {
  ...
  **/
  @Schema(description = "The Client Username the Bridge uses to login to the remote Message VPN. This per remote Message VPN value overrides the value provided for the Bridge overall. The default value is `\"\"`.")
  ...
  **/
  @Schema(description = "Enable or disable data compression for the remote Message VPN connection. The default value is `false`.")
   ...
   * @return connectOrder
  **/
  @Schema(description = "The preference given to incoming connections from remote Message VPN hosts, from 1 (highest priority) to 4 (lowest priority). The default value is `4`.")
  ...
  **/
  @Schema(description = "The number of outstanding guaranteed messages that can be transmitted over the remote Message VPN connection before an acknowledgement is received. The default value is `255`.")
   ...
   * @return enabled
  **/
  @Schema(description = "Enable or disable the remote Message VPN. The default value is `false`.")
  ...
  **/
   ...
   * @return queueBinding
  **/
  @Schema(description = "The queue binding of the Bridge in the remote Message VPN. The default value is `\"\"`.")
  ...
  **/
   ...
   * @return tlsEnabled
  **/
  @Schema(description = "Enable or disable encryption (TLS) for the remote Message VPN connection. The default value is `false`.")
  ...
  **/
  @Schema(description = "The Client Profile for the unidirectional Bridge of the remote Message VPN. The Client Profile must exist in the local Message VPN, and it is used only for the TCP parameters. Note that the default client profile has a TCP maximum window size of 2MB. The default value is `\"#client-profile\"`.")
