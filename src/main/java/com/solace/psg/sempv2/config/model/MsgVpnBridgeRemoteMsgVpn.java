...
public class MsgVpnBridgeRemoteMsgVpn {
  ...
  **/
  @ApiModelProperty(value = "The Client Username the Bridge uses to login to the remote Message VPN. This per remote Message VPN value overrides the value provided for the Bridge overall. The default value is `\"\"`.")
  ...
  **/
  @ApiModelProperty(value = "Enable or disable data compression for the remote Message VPN connection. The default value is `false`.")
   ...
   * @return connectOrder
  **/
  @ApiModelProperty(value = "The preference given to incoming connections from remote Message VPN hosts, from 1 (highest priority) to 4 (lowest priority). The default value is `4`.")
  ...
  **/
  @ApiModelProperty(value = "The number of outstanding guaranteed messages that can be transmitted over the remote Message VPN connection before an acknowledgement is received. The default value is `255`.")
   ...
   * @return enabled
  **/
  @ApiModelProperty(value = "Enable or disable the remote Message VPN. The default value is `false`.")
  ...
  **/
   ...
   * @return password
  **/
  @ApiModelProperty(value = "The password for the Client Username. This attribute is absent from a GET and not updated when absent in a PUT. The default is to have no `password`.")
   ...
   * @return queueBinding
  **/
  @ApiModelProperty(value = "The queue binding of the Bridge in the remote Message VPN. The default value is `\"\"`.")
  ...
  **/
   ...
   * @return tlsEnabled
  **/
  @ApiModelProperty(value = "Enable or disable encryption (TLS) for the remote Message VPN connection. The default value is `false`.")
  ...
  **/
  @ApiModelProperty(value = "The Client Profile for the unidirectional Bridge of the remote Message VPN. The Client Profile must exist in the local Message VPN, and it is used only for the TCP parameters. Note that the default client profile has a TCP maximum window size of 2MB. The default value is `\"#client-profile\"`.")
