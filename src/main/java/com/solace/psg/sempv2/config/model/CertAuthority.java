...
public class CertAuthority {
  ...
  **/
  ...
  public CertAuthority certContent(String certContent) {
   ...
   /**
   * The PEM formatted content for the trusted root certificate of a Certificate Authority. The default value is &#x60;\&quot;\&quot;&#x60;.
   * @return certContent
  **/
  @Schema(description = "The PEM formatted content for the trusted root certificate of a Certificate Authority. The default value is `\"\"`.")
   ...
   * @return crlDayList
  **/
  @Schema(description = "The scheduled CRL refresh day(s), specified as \"daily\" or a comma-separated list of days. Days must be specified as \"Sun\", \"Mon\", \"Tue\", \"Wed\", \"Thu\", \"Fri\", or \"Sat\", with no spaces, and in sorted order from Sunday to Saturday. The default value is `\"daily\"`.")
   ...
   * @return crlTimeList
  **/
  @Schema(description = "The scheduled CRL refresh time(s), specified as \"hourly\" or a comma-separated list of 24-hour times in the form hh:mm, or h:mm. There must be no spaces, and times must be in sorted order from 0:00 to 23:59. The default value is `\"3:00\"`.")
   ...
   * @return crlUrl
  **/
  @Schema(description = "The URL for the CRL source. This is a required attribute for CRL to be operational and the URL must be complete with http:// included. The default value is `\"\"`.")
  ...
  **/
  @Schema(description = "Enable or disable allowing a non-responder certificate to sign an OCSP response. Typically used with an OCSP override URL in cases where a single certificate is used to sign client certificates and OCSP responses. The default value is `false`.")
  ...
  **/
  @Schema(description = "The OCSP responder URL to use for overriding the one supplied in the client certificate. The URL must be complete with http:// included. The default value is `\"\"`.")
   ...
   * @return ocspTimeout
  **/
  @Schema(description = "The timeout in seconds to receive a response from the OCSP responder after sending a request or making the initial connection attempt. The default value is `5`.")
  ...
  **/
  @Schema(description = "Enable or disable Certificate Authority revocation checking. The default value is `false`.")
