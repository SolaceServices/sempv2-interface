...
public class MsgVpnRestDeliveryPointRestConsumer {
  ...
  **/
  @Schema(description = "The PEM formatted content for the client certificate that the REST Consumer will present to the REST host. It must consist of a private key and between one and three certificates comprising the certificate trust chain. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4. Changing this attribute requires an HTTPS connection. The default value is `\"\"`. Available since 2.9.")
  ...
  **/
  @Schema(description = "The password for the username. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4. The default value is `\"\"`.")
  ...
  **/
  @Schema(description = "The username that the REST Consumer will use to login to the REST host. Normally a username is only configured when basic authentication is selected for the REST Consumer. The default value is `\"\"`.")
  ...
  **/
  @Schema(description = "The authentication header name. The default value is `\"\"`. Available since 2.15.")
  ...
  **/
  @Schema(description = "The authentication header value. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4. The default value is `\"\"`. Available since 2.15.")
  ...
  **/
   ...
   * @return enabled
  **/
  @Schema(description = "Enable or disable the REST Consumer. When disabled, no connections are initiated or messages delivered to this particular REST Consumer. The default value is `false`.")
   ...
   * @return httpMethod
  **/
  @Schema(description = "The HTTP method to use (POST or PUT). This is used only when operating in the REST service \"messaging\" mode and is ignored in \"gateway\" mode. The default value is `\"post\"`. The allowed values and their meaning are:  <pre> \"post\" - Use the POST HTTP method. \"put\" - Use the PUT HTTP method. </pre>  Available since 2.17.")
  ...
  **/
  @Schema(description = "The interface that will be used for all outgoing connections associated with the REST Consumer. When unspecified, an interface is automatically chosen. The default value is `\"\"`.")
  ...
  **/
  @Schema(description = "The maximum amount of time (in seconds) to wait for an HTTP POST response from the REST Consumer. Once this time is exceeded, the TCP connection is reset. The default value is `30`.")
  ...
  **/
  @Schema(description = "The number of concurrent TCP connections open to the REST Consumer. The default value is `3`.")
   ...
   * @return remoteHost
  **/
  @Schema(description = "The IP address or DNS name to which the broker is to connect to deliver messages for the REST Consumer. A host value must be configured for the REST Consumer to be operationally up. The default value is `\"\"`.")
   ...
   * @return remotePort
  **/
  @Schema(description = "The port associated with the host of the REST Consumer. The default value is `8080`.")
  ...
  **/
   ...
   * @return retryDelay
  **/
  @Schema(description = "The number of seconds that must pass before retrying the remote REST Consumer connection. The default value is `3`.")
  ...
  **/
   ...
   * @return tlsEnabled
  **/
  @Schema(description = "Enable or disable encryption (TLS) for the REST Consumer. The default value is `false`.")
