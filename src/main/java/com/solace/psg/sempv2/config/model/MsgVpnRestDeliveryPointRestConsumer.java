...
public class MsgVpnRestDeliveryPointRestConsumer {
  ...
  **/
  @ApiModelProperty(value = "The password for the username. This attribute is absent from a GET and not updated when absent in a PUT. The default value is `\"\"`.")
  ...
  **/
  @ApiModelProperty(value = "The username that the REST Consumer will use to login to the REST host. Normally a username is only configured when basic authentication is selected for the REST Consumer. The default value is `\"\"`.")
  ...
  **/
   ...
   * @return enabled
  **/
  @ApiModelProperty(value = "Enable or disable the REST Consumer. When disabled, no connections are initiated or messages delivered to this particular REST Consumer. The default value is `false`.")
  ...
  **/
  @ApiModelProperty(value = "The interface that will be used for all outgoing connections associated with the REST Consumer. When unspecified, an interface is automatically chosen. The default value is `\"\"`.")
  ...
  **/
  @ApiModelProperty(value = "The maximum amount of time (in seconds) to wait for an HTTP POST response from the REST Consumer. Once this time is exceeded, the TCP connection is reset. The default value is `30`.")
  ...
  **/
  @ApiModelProperty(value = "The number of concurrent TCP connections open to the REST Consumer. The default value is `3`.")
   ...
   * @return remoteHost
  **/
  @ApiModelProperty(value = "The IP address or DNS name to which the broker is to connect to deliver messages for the REST Consumer. A host value must be configured for the REST Consumer to be operationally up. The default value is `\"\"`.")
   ...
   * @return remotePort
  **/
  @ApiModelProperty(value = "The port associated with the host of the REST Consumer. The default value is `8080`.")
  ...
  **/
   ...
   * @return retryDelay
  **/
  @ApiModelProperty(value = "The number of seconds that must pass before retrying the remote REST Consumer connection. The default value is `3`.")
  ...
  **/
   ...
   * @return tlsEnabled
  **/
  @ApiModelProperty(value = "Enable or disable encryption (TLS) for the REST Consumer. The default value is `false`.")
