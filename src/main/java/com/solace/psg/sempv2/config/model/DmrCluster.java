...
public class DmrCluster {
  ...
  **/
  @ApiModelProperty(value = "Enable or disable basic authentication for Cluster Links. The default value is `true`.")
  ...
  **/
  @ApiModelProperty(value = "The type of basic authentication to use for Cluster Links. The default value is `\"internal\"`. The allowed values and their meaning are:  <pre> \"internal\" - Use locally configured password. \"none\" - No authentication. </pre> ")
  ...
  **/
  @ApiModelProperty(value = "Enable or disable client certificate authentication for Cluster Links. The default value is `true`.")
  ...
  **/
  @ApiModelProperty(value = "The password for the client certificate. This attribute is absent from a GET and not updated when absent in a PUT. Changing this attribute requires an HTTPS connection. The default value is `\"\"`.")
  ...
  **/
   ...
   * @return enabled
  **/
  @ApiModelProperty(value = "Enable or disable the Cluster. The default value is `false`.")
  ...
  **/
  @ApiModelProperty(value = "The maximum allowed depth of a certificate chain. The depth of a chain is defined as the number of signing CA certificates that are present in the chain back to a trusted self-signed root CA certificate. The default value is `3`.")
  ...
  **/
  @ApiModelProperty(value = "Enable or disable the validation of the \"Not Before\" and \"Not After\" validity dates in the certificate. When disabled, the certificate is accepted even if the certificate is not valid based on these dates. The default value is `true`.")
